...
public:
  ColorGradientCollideSweepDoublePrecision(
      ...
      BlockDataID rho_bID_, BlockDataID velocityID_, double beta,
      double omega_even_a, double omega_even_b, double omega_odd_a,
      double omega_odd_b, double omega_shear_a, double omega_shear_b,
      double sigma)
  ...
  getSweep(const shared_ptr<ColorGradientCollideSweepDoublePrecision> &kernel) {
    return [kernel](IBlock *b) { kernel->run(b); };
  }

  static std::function<void(IBlock *)> getSweepOnCellInterval(
      const shared_ptr<ColorGradientCollideSweepDoublePrecision> &kernel,
