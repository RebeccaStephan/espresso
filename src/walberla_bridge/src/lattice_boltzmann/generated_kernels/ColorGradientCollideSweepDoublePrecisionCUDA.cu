...
static FUNC_PREFIX __launch_bounds__(256) void colorgradientcollidesweepdoubleprecisioncuda_colorgradientcollidesweepdoubleprecisioncuda(double * RESTRICT const _data_force_a, double * RESTRICT const _data_force_b, double * RESTRICT  _data_pdfs_a, double * RESTRICT  _data_pdfs_b, double * RESTRICT const _data_phasefield, double * RESTRICT const _data_rho_a, double * RESTRICT const _data_rho_b, double * RESTRICT const _data_velocity, int64_t const _size_force_a_0, int64_t const _size_force_a_1, int64_t const _size_force_a_2, int64_t const _stride_force_a_0, int64_t const _stride_force_a_1, int64_t const _stride_force_a_2, int64_t const _stride_force_a_3, int64_t const _stride_force_b_0, int64_t const _stride_force_b_1, int64_t const _stride_force_b_2, int64_t const _stride_force_b_3, int64_t const _stride_pdfs_a_0, int64_t const _stride_pdfs_a_1, int64_t const _stride_pdfs_a_2, int64_t const _stride_pdfs_a_3, int64_t const _stride_pdfs_b_0, int64_t const _stride_pdfs_b_1, int64_t const _stride_pdfs_b_2, int64_t const _stride_pdfs_b_3, int64_t const _stride_phasefield_0, int64_t const _stride_phasefield_1, int64_t const _stride_phasefield_2, int64_t const _stride_rho_a_0, int64_t const _stride_rho_a_1, int64_t const _stride_rho_a_2, int64_t const _stride_rho_b_0, int64_t const _stride_rho_b_1, int64_t const _stride_rho_b_2, int64_t const _stride_velocity_0, int64_t const _stride_velocity_1, int64_t const _stride_velocity_2, int64_t const _stride_velocity_3, double beta, double omega_even_a, double omega_even_b, double omega_odd_a, double omega_odd_b, double omega_shear_a, double omega_shear_b, double sigma)
{
   if (blockDim.x*blockIdx.x + threadIdx.x + 1 < _size_force_a_0 - 1 && blockDim.y*blockIdx.y + threadIdx.y + 1 < _size_force_a_1 - 1 && blockDim.z*blockIdx.z + threadIdx.z + 1 < _size_force_a_2 - 1)
   {
      ...
      const double xia_1_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 18*_stride_pdfs_a_3];
      const double xia_2_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 5*_stride_pdfs_a_3];
      ...
      const double xia_4_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 10*_stride_pdfs_a_3];
      const double xi_177 = xia_3_collide + xia_4_collide;
      const double xia_5_collide = _data_rho_a[_stride_rho_a_0*ctr_0 + _stride_rho_a_1*ctr_1 + _stride_rho_a_2*ctr_2];
      ...
      const double xia_7_collide = _data_force_a[_stride_force_a_0*ctr_0 + _stride_force_a_1*ctr_1 + _stride_force_a_2*ctr_2];
      const double xi_17 = xia_7_collide*0.16666666666666666;
      const double xi_18 = omega_odd_a*xi_17;
      const double xi_32 = xia_7_collide*0.083333333333333329;
      const double xi_34 = xi_33*xia_7_collide;
      ...
      const double xia_9_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 2*_stride_pdfs_a_3];
      ...
      const double xi_174 = xia_10_collide + xia_1_collide;
      const double xia_11_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 17*_stride_pdfs_a_3];
      const double xia_12_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 14*_stride_pdfs_a_3];
      const double xi_175 = xi_174 + xia_11_collide + xia_12_collide;
      const double xi_265 = -xia_12_collide;
      const double xi_266 = xi_265 + xia_11_collide;
      ...
      const double xia_14_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 8*_stride_pdfs_a_3];
      const double xi_253 = -xia_14_collide;
      const double xia_15_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 3*_stride_pdfs_a_3];
      const double xia_16_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 12*_stride_pdfs_a_3];
      const double xia_17_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 4*_stride_pdfs_a_3];
      ...
      const double xia_19_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 9*_stride_pdfs_a_3];
      const double xi_178 = xi_177 + xia_14_collide + xia_19_collide;
      const double xi_254 = xi_253 + xia_19_collide;
      const double xia_20_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 15*_stride_pdfs_a_3];
      const double xi_170 = xia_16_collide + xia_20_collide;
      const double xia_21_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 6*_stride_pdfs_a_3];
      const double xia_22_collide = _data_force_a[_stride_force_a_0*ctr_0 + _stride_force_a_1*ctr_1 + _stride_force_a_2*ctr_2 + 2*_stride_force_a_3];
      const double xi_26 = xia_22_collide*0.16666666666666666;
      const double xi_28 = omega_odd_a*xi_26;
      const double xi_55 = xia_22_collide*0.083333333333333329;
      const double xi_56 = xi_33*xia_22_collide;
      const double xi_57 = xi_55 - xi_56;
      const double xi_70 = -xi_55 + xi_56;
      const double xia_23_collide = _data_velocity[_stride_velocity_0*ctr_0 + _stride_velocity_1*ctr_1 + _stride_velocity_2*ctr_2];
      const double xia_24_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + _stride_pdfs_a_3];
      const double xia_25_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2];
      const double xia_26_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 11*_stride_pdfs_a_3];
      const double xi_171 = xi_170 + xia_26_collide + xia_6_collide;
      const double xi_248 = -xia_26_collide;
      const double xi_249 = xi_248 + xia_6_collide;
      const double rr_0_a_collide = 0.0;
      const double xi_5 = rr_0_a_collide*0.25;
      const double xi_6 = xi_5*xia_8_collide;
      const double xi_19 = xi_5*xia_7_collide;
      const double xi_27 = xi_5*xia_22_collide;
      const double rho_a_collide = xia_5_collide;
      ...
      const double u_0_a_collide = xia_23_collide;
      const double xi_0 = u_0_a_collide*xia_7_collide;
      ...
      const double xi_73 = u_0_a_collide*xia_22_collide;
      ...
      const double xi_182 = omega_shear_a*(rho_a_collide*xi_169 - xi_178 - xi_181 - xia_15_collide - xia_17_collide);
      const double xi_264 = u_0_a_collide*xi_246;
      const double xi_267 = xi_264 + xi_266 + xia_10_collide - xia_1_collide;
      const double xi_268 = xi_251*xi_267;
      const double xi_269 = xi_254 + xi_264 + xia_3_collide - xia_4_collide;
      ...
      const double xi_44 = xi_43*xia_7_collide;
      const double xi_48 = u_1_a_collide*xi_45;
      const double xi_49 = xi_48*xia_7_collide;
      const double xi_50 = xi_42 + xi_44 - xi_47 - xi_49;
      const double xi_52 = -xi_42 - xi_44 + xi_47 + xi_49;
      const double xi_59 = -xi_23;
      const double xi_63 = xi_43*xia_22_collide;
      const double xi_65 = xi_48*xia_22_collide;
      ...
      const double xi_183 = omega_shear_a*(rho_a_collide*xi_167 - xi_171 - xi_178 - xi_180 - xia_24_collide - xia_9_collide);
      const double xi_247 = u_1_a_collide*xi_246;
      const double xi_250 = xi_247 + xi_249 + xia_16_collide - xia_20_collide;
      const double xi_252 = xi_250*xi_251;
      const double xi_255 = xi_247 + xi_254 - xia_3_collide + xia_4_collide;
      const double xi_256 = xi_251*xi_255;
      const double xi_286 = rho_a_collide*u_1_a_collide;
      const double xi_288 = xi_287*(u_0_a_collide*xi_286 + xi_177 + xi_253 - xia_19_collide);
      const double xi_289 = -xi_288;
      const double xi_300 = xi_255*xi_283;
      const double xi_311 = xi_250*xi_283;
      const double xi_321 = -xi_311;
      const double u_2_a_collide = xia_13_collide;
      const double xi_2 = u_2_a_collide*xia_22_collide;
      ...
      const double xi_36 = omega_even_a*u_2_a_collide*xia_22_collide*-0.041666666666666664;
      ...
      const double xi_75 = u_2_a_collide*xia_7_collide;
      ...
      const double xi_184 = omega_shear_a*(rho_a_collide*xi_165 - xi_171 - xi_181 - xia_21_collide - xia_2_collide);
      ...
      const double xi_276 = xi_266 + xi_275 - xia_10_collide + xia_1_collide;
      const double xi_277 = xi_251*xi_276;
      const double xi_278 = xi_249 + xi_275 - xia_16_collide + xia_20_collide;
      ...
      const double xi_312 = xi_287*(u_2_a_collide*xi_286 + xi_170 + xi_248 - xia_6_collide);
      ...
      const double xi_329 = xi_287*(rho_a_collide*u_0_a_collide*u_2_a_collide + xi_174 + xi_265 - xia_11_collide);
      ...
      const double forceTerm_0_a_collide = omega_shear_a*u_0_a_collide*xia_7_collide + omega_shear_a*u_1_a_collide*xia_8_collide + omega_shear_a*u_2_a_collide*xia_22_collide - xi_0*xi_3 - xi_0 - xi_1*xi_3 - xi_1 - xi_2*xi_3 - xi_2;
      ...
      const double xib_1_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + _stride_pdfs_b_3];
      const double xib_2_collide = _data_force_b[_stride_force_b_0*ctr_0 + _stride_force_b_1*ctr_1 + _stride_force_b_2*ctr_2 + _stride_force_b_3];
      const double xi_86 = xib_2_collide*0.16666666666666666;
      const double xi_89 = omega_odd_b*xi_86;
      const double xi_119 = xib_2_collide*0.083333333333333329;
      const double xi_120 = xi_115*xib_2_collide;
      const double xi_121 = -xi_119 + xi_120;
      const double xi_123 = xib_2_collide*0.25;
      const double xi_128 = xi_127*xib_2_collide;
      const double xi_135 = xi_119 - xi_120;
      const double xib_3_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 17*_stride_pdfs_b_3];
      const double xib_4_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 13*_stride_pdfs_b_3];
      const double xib_5_collide = _data_force_b[_stride_force_b_0*ctr_0 + _stride_force_b_1*ctr_1 + _stride_force_b_2*ctr_2];
      const double xi_99 = xib_5_collide*0.16666666666666666;
      const double xi_100 = omega_odd_b*xi_99;
      const double xi_114 = xib_5_collide*0.083333333333333329;
      const double xi_116 = xi_115*xib_5_collide;
      const double xi_117 = xi_114 - xi_116;
      const double xi_133 = -xi_114 + xi_116;
      const double xib_6_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 9*_stride_pdfs_b_3];
      const double xib_7_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 8*_stride_pdfs_b_3];
      const double xi_374 = -xib_7_collide;
      const double xi_375 = xi_374 + xib_6_collide;
      const double xib_8_collide = _data_rho_b[_stride_rho_b_0*ctr_0 + _stride_rho_b_1*ctr_1 + _stride_rho_b_2*ctr_2];
      const double xib_9_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 3*_stride_pdfs_b_3];
      const double xib_10_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 5*_stride_pdfs_b_3];
      const double xib_11_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 18*_stride_pdfs_b_3];
      const double xi_356 = xib_11_collide + xib_4_collide;
      const double xib_12_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2];
      const double xib_13_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 7*_stride_pdfs_b_3];
      const double xib_14_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 2*_stride_pdfs_b_3];
      ...
      const double xib_18_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 14*_stride_pdfs_b_3];
      const double xi_357 = xi_356 + xib_18_collide + xib_3_collide;
      const double xi_384 = -xib_18_collide;
      const double xi_385 = xi_384 + xib_3_collide;
      const double xib_19_collide = _data_velocity[_stride_velocity_0*ctr_0 + _stride_velocity_1*ctr_1 + _stride_velocity_2*ctr_2 + 2*_stride_velocity_3];
      ...
      const double xi_359 = xib_13_collide + xib_20_collide;
      const double xi_360 = xi_359 + xib_6_collide + xib_7_collide;
      const double xib_21_collide = _data_velocity[_stride_velocity_0*ctr_0 + _stride_velocity_1*ctr_1 + _stride_velocity_2*ctr_2 + _stride_velocity_3];
      ...
      const double xi_370 = xi_369 + xib_17_collide;
      ...
      const double xi_352 = xib_16_collide + xib_25_collide;
      const double xi_353 = xi_352 + xib_17_collide + xib_24_collide;
      const double xib_26_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 6*_stride_pdfs_b_3];
      const double rr_0_b_collide = 0.0;
      const double xi_87 = rr_0_b_collide*0.25;
      const double xi_88 = xi_87*xib_2_collide;
      const double xi_101 = xi_87*xib_5_collide;
      const double xi_109 = xi_87*xib_15_collide;
      const double rho_b_collide = xib_8_collide;
      const double xi_346 = rho_b_collide*-0.1111111111111111;
      const double xi_362 = rho_b_collide*-0.33333333333333331;
      const double xi_363 = xi_357 + xi_362;
      const double xi_367 = rho_b_collide*0.33333333333333331;
      const double u_0_b_collide = xib_23_collide;
      const double xi_82 = u_0_b_collide*xib_5_collide;
      ...
      const double xi_351 = u_0_b_collide*u_0_b_collide;
      const double xi_355 = rho_b_collide*xi_351*-0.33333333333333331 + xi_346;
      const double xi_364 = omega_shear_b*(rho_b_collide*xi_351 - xi_360 - xi_363 - xib_22_collide - xib_9_collide);
      const double xi_381 = u_0_b_collide*xi_367;
      const double xi_382 = xi_375 + xi_381 + xib_13_collide - xib_20_collide;
      const double xi_383 = xi_372*xi_382;
      const double xi_386 = xi_381 + xi_385 - xib_11_collide + xib_4_collide;
      ...
      const double u_1_b_collide = xib_21_collide;
      const double xi_83 = u_1_b_collide*xib_2_collide;
      ...
      const double xi_126 = xi_125*xib_5_collide;
      const double xi_130 = u_1_b_collide*xi_127;
      const double xi_131 = xi_130*xib_5_collide;
      ...
      const double xi_153 = omega_even_b*u_1_b_collide*xib_2_collide*-0.041666666666666664;
      const double xi_349 = u_1_b_collide*u_1_b_collide;
      const double xi_350 = rho_b_collide*xi_349*-0.33333333333333331;
      const double xi_365 = omega_shear_b*(rho_b_collide*xi_349 - xi_353 - xi_360 - xi_362 - xib_14_collide - xib_1_collide);
      const double xi_368 = u_1_b_collide*xi_367;
      const double xi_371 = xi_368 + xi_370 + xib_16_collide - xib_25_collide;
      const double xi_373 = xi_371*xi_372;
      const double xi_376 = xi_368 + xi_375 - xib_13_collide + xib_20_collide;
      const double xi_377 = xi_372*xi_376;
      const double xi_399 = rho_b_collide*u_1_b_collide;
      const double xi_401 = xi_400*(u_0_b_collide*xi_399 + xi_359 + xi_374 - xib_6_collide);
      const double xi_402 = -xi_401;
      const double xi_404 = xi_376*xi_396;
      const double xi_407 = xi_371*xi_396;
      const double xi_412 = -xi_407;
      const double u_2_b_collide = xib_19_collide;
      ...
      const double xi_157 = u_2_b_collide*xib_5_collide;
      ...
      const double xi_347 = u_2_b_collide*u_2_b_collide;
      const double xi_348 = rho_b_collide*xi_347*-0.33333333333333331;
      const double xi_354 = omega_even_b*(rho_b_collide*xi_351*-0.16666666666666666 - xi_346 - xi_348 - xi_350 - xi_353);
      const double xi_358 = omega_even_b*(rho_b_collide*xi_349*-0.16666666666666666 - xi_348 - xi_355 - xi_357);
      const double xi_361 = omega_even_b*(rho_b_collide*xi_347*-0.16666666666666666 - xi_350 - xi_355 - xi_360);
      const double xi_366 = omega_shear_b*(rho_b_collide*xi_347 - xi_353 - xi_363 - xib_10_collide - xib_26_collide);
      const double xi_378 = xi_361*-0.5;
      const double xi_379 = xi_354*-0.5;
      const double xi_380 = xi_365*0.5 + xi_378 + xi_379;
      const double xi_388 = xi_358*-0.5;
      const double xi_389 = xi_364*0.5 + xi_378 + xi_388;
      const double xi_390 = u_2_b_collide*xi_367;
      const double xi_391 = xi_385 + xi_390 + xib_11_collide - xib_4_collide;
      const double xi_392 = xi_372*xi_391;
      const double xi_393 = xi_370 + xi_390 - xib_16_collide + xib_25_collide;
      const double xi_394 = xi_372*xi_393;
      const double xi_395 = xi_366*0.5 + xi_379 + xi_388;
      const double xi_403 = xi_361*0.25;
      const double xi_405 = xi_403 + xi_404;
      const double xi_406 = xi_403 - xi_404;
      const double xi_408 = xi_400*(u_2_b_collide*xi_399 + xi_352 + xi_369 - xib_17_collide);
      ...
      const double xi_416 = xi_400*(rho_b_collide*u_0_b_collide*u_2_b_collide + xi_356 + xi_384 - xib_3_collide);
      ...
      const double forceTerm_0_b_collide = omega_shear_b*u_0_b_collide*xib_5_collide + omega_shear_b*u_1_b_collide*xib_2_collide + omega_shear_b*u_2_b_collide*xib_15_collide - xi_82*xi_85 - xi_82 - xi_83*xi_85 - xi_83 - xi_84*xi_85 - xi_84;
      ...
      const double tmp_a1 = forceTerm_1_a_collide - xi_252 - xi_256 + xi_259 + xi_262 + xia_24_collide;
      const double tmp_a2 = forceTerm_2_a_collide + xi_252 + xi_256 + xi_262 + xi_263 + xia_9_collide;
      const double tmp_a3 = forceTerm_3_a_collide + xi_268 + xi_270 + xi_271 + xi_273 + xia_15_collide;
      const double tmp_a4 = forceTerm_4_a_collide - xi_268 - xi_270 + xi_273 + xi_274 + xia_17_collide;
      const double tmp_a5 = forceTerm_5_a_collide - xi_277 - xi_279 + xi_280 + xi_281 + xia_2_collide;
      const double tmp_a6 = forceTerm_6_a_collide + xi_277 + xi_279 + xi_281 + xi_282 + xia_21_collide;
      const double tmp_a7 = forceTerm_7_a_collide + xi_285 + xi_289 + xi_298 + xi_301 + xia_3_collide;
      const double tmp_a8 = forceTerm_8_a_collide + xi_284 + xi_288 + xi_301 + xi_307 + xia_14_collide;
      const double tmp_a9 = forceTerm_9_a_collide + xi_285 + xi_288 + xi_308 + xi_309 + xia_19_collide;
      const double tmp_a10 = forceTerm_10_a_collide + xi_284 + xi_289 + xi_309 + xi_310 + xia_4_collide;
      const double tmp_a11 = forceTerm_11_a_collide + xi_311 + xi_312 + xi_317 + xi_320 + xia_26_collide;
      const double tmp_a12 = forceTerm_12_a_collide + xi_320 + xi_321 + xi_322 + xi_326 + xia_16_collide;
      const double tmp_a13 = forceTerm_13_a_collide + xi_328 + xi_330 + xi_333 + xi_336 + xia_10_collide;
      const double tmp_a14 = forceTerm_14_a_collide + xi_327 + xi_329 + xi_336 + xi_339 + xia_12_collide;
      const double tmp_a15 = forceTerm_15_a_collide + xi_311 + xi_322 + xi_340 + xi_341 + xia_20_collide;
      const double tmp_a16 = forceTerm_16_a_collide + xi_312 + xi_321 + xi_341 + xi_342 + xia_6_collide;
      const double tmp_a17 = forceTerm_17_a_collide + xi_328 + xi_329 + xi_343 + xi_344 + xia_11_collide;
      const double tmp_a18 = forceTerm_18_a_collide + xi_327 + xi_330 + xi_344 + xi_345 + xia_1_collide;
      const double tmp_b0 = forceTerm_0_b_collide + xi_245 + xi_354 + xi_358 + xi_361 - xi_364 - xi_365 - xi_366 + xib_12_collide;
      const double tmp_b1 = forceTerm_1_b_collide + xi_259 - xi_373 - xi_377 + xi_380 + xib_1_collide;
      const double tmp_b2 = forceTerm_2_b_collide + xi_263 + xi_373 + xi_377 + xi_380 + xib_14_collide;
      const double tmp_b3 = forceTerm_3_b_collide + xi_271 + xi_383 + xi_387 + xi_389 + xib_9_collide;
      const double tmp_b4 = forceTerm_4_b_collide + xi_274 - xi_383 - xi_387 + xi_389 + xib_22_collide;
      const double tmp_b5 = forceTerm_5_b_collide + xi_280 - xi_392 - xi_394 + xi_395 + xib_10_collide;
      const double tmp_b6 = forceTerm_6_b_collide + xi_282 + xi_392 + xi_394 + xi_395 + xib_26_collide;
      const double tmp_b7 = forceTerm_7_b_collide + xi_298 + xi_398 + xi_402 + xi_405 + xib_13_collide;
      const double tmp_b8 = forceTerm_8_b_collide + xi_307 + xi_397 + xi_401 + xi_405 + xib_7_collide;
      const double tmp_b9 = forceTerm_9_b_collide + xi_308 + xi_398 + xi_401 + xi_406 + xib_6_collide;
      const double tmp_b10 = forceTerm_10_b_collide + xi_310 + xi_397 + xi_402 + xi_406 + xib_20_collide;
      const double tmp_b11 = forceTerm_11_b_collide + xi_317 + xi_407 + xi_408 + xi_411 + xib_24_collide;
      const double tmp_b12 = forceTerm_12_b_collide + xi_326 + xi_411 + xi_412 + xi_413 + xib_16_collide;
      const double tmp_b13 = forceTerm_13_b_collide + xi_333 + xi_415 + xi_417 + xi_420 + xib_4_collide;
      const double tmp_b14 = forceTerm_14_b_collide + xi_339 + xi_414 + xi_416 + xi_420 + xib_18_collide;
      const double tmp_b15 = forceTerm_15_b_collide + xi_340 + xi_407 + xi_413 + xi_421 + xib_25_collide;
      const double tmp_b16 = forceTerm_16_b_collide + xi_342 + xi_408 + xi_412 + xi_421 + xib_17_collide;
      const double tmp_b17 = forceTerm_17_b_collide + xi_343 + xi_415 + xi_416 + xi_422 + xib_3_collide;
      const double tmp_b18 = forceTerm_18_b_collide + xi_345 + xi_414 + xi_417 + xi_422 + xib_11_collide;
