...
static FUNC_PREFIX __launch_bounds__(256) void colorgradientcollidesweepdoubleprecisioncuda_colorgradientcollidesweepdoubleprecisioncuda(double * RESTRICT const _data_force_a, double * RESTRICT const _data_force_b, double * RESTRICT  _data_pdfs_a, double * RESTRICT  _data_pdfs_b, double * RESTRICT const _data_phasefield, double * RESTRICT const _data_rho_a, double * RESTRICT const _data_rho_b, double * RESTRICT const _data_velocity, int64_t const _size_force_a_0, int64_t const _size_force_a_1, int64_t const _size_force_a_2, int64_t const _stride_force_a_0, int64_t const _stride_force_a_1, int64_t const _stride_force_a_2, int64_t const _stride_force_a_3, int64_t const _stride_force_b_0, int64_t const _stride_force_b_1, int64_t const _stride_force_b_2, int64_t const _stride_force_b_3, int64_t const _stride_pdfs_a_0, int64_t const _stride_pdfs_a_1, int64_t const _stride_pdfs_a_2, int64_t const _stride_pdfs_a_3, int64_t const _stride_pdfs_b_0, int64_t const _stride_pdfs_b_1, int64_t const _stride_pdfs_b_2, int64_t const _stride_pdfs_b_3, int64_t const _stride_phasefield_0, int64_t const _stride_phasefield_1, int64_t const _stride_phasefield_2, int64_t const _stride_rho_a_0, int64_t const _stride_rho_a_1, int64_t const _stride_rho_a_2, int64_t const _stride_rho_b_0, int64_t const _stride_rho_b_1, int64_t const _stride_rho_b_2, int64_t const _stride_velocity_0, int64_t const _stride_velocity_1, int64_t const _stride_velocity_2, int64_t const _stride_velocity_3, double beta, uint32_t block_offset_0, uint32_t block_offset_1, uint32_t block_offset_2, double kT, double omega_shear_a, double omega_shear_b, uint32_t seed, double sigma, uint32_t time_step)
{
   if (blockDim.x*blockIdx.x + threadIdx.x + 1 < _size_force_a_0 - 1 && blockDim.y*blockIdx.y + threadIdx.y + 1 < _size_force_a_1 - 1 && blockDim.z*blockIdx.z + threadIdx.z + 1 < _size_force_a_2 - 1)
   {
      ...
      const double xi_354 = random_4_1 - 0.5;
      ...
      const double xi_490 = random_14_0_shifted - 0.5;
      const double xi_492 = random_15_0_shifted - 0.5;
      const double xi_494 = random_8_0_shifted - 0.5;
      const double xi_496 = random_14_1_shifted - 0.5;
      const double xi_503 = random_9_0_shifted - 0.5;
      const double xi_517 = random_13_1_shifted - 0.5;
      const double xi_525 = random_11_0_shifted - 0.5;
      const double xi_539 = random_8_1_shifted - 0.5;
      const double xi_556 = random_12_1_shifted - 0.5;
      const double xi_559 = random_12_0_shifted - 0.5;
      const double xi_568 = random_13_0_shifted - 0.5;
      const double xi_571 = random_11_1_shifted - 0.5;
      const double xia_3_collide = _data_force_a[_stride_force_a_0*ctr_0 + _stride_force_a_1*ctr_1 + _stride_force_a_2*ctr_2 + 2*_stride_force_a_3];
      const double xi_52 = xia_3_collide*0.083333333333333329;
      const double xia_4_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 7*_stride_pdfs_a_3];
      const double xia_5_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 13*_stride_pdfs_a_3];
      const double xi_208 = xia_5_collide*2.0;
      const double xia_6_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 5*_stride_pdfs_a_3];
      const double xi_328 = -xia_6_collide;
      const double xia_7_collide = _data_velocity[_stride_velocity_0*ctr_0 + _stride_velocity_1*ctr_1 + _stride_velocity_2*ctr_2];
      const double xia_8_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 12*_stride_pdfs_a_3];
      const double xi_301 = -xia_8_collide;
      ...
      const double xi_312 = -xia_9_collide;
      ...
      const double xi_313 = xia_11_collide*2.0;
      ...
      const double xi_329 = -xia_12_collide;
      const double xia_13_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 2*_stride_pdfs_a_3];
      ...
      const double xi_209 = xia_10_collide*2.0 + xia_14_collide*2.0;
      const double xi_351 = xia_10_collide - xia_14_collide;
      const double xia_15_collide = _data_velocity[_stride_velocity_0*ctr_0 + _stride_velocity_1*ctr_1 + _stride_velocity_2*ctr_2 + _stride_velocity_3];
      const double xia_16_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 14*_stride_pdfs_a_3];
      const double xi_207 = xia_16_collide*2.0;
      const double xi_352 = xi_351 + xia_16_collide - xia_5_collide;
      ...
      const double xi_203 = xia_17_collide + xia_4_collide;
      const double xi_315 = xia_17_collide*-2.0 + xia_4_collide*2.0;
      const double xia_18_collide = _data_rho_a[_stride_rho_a_0*ctr_0 + _stride_rho_a_1*ctr_1 + _stride_rho_a_2*ctr_2];
      const double xia_19_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 11*_stride_pdfs_a_3];
      const double xi_200 = xia_19_collide + xia_8_collide;
      const double xi_314 = -xia_19_collide + xia_8_collide;
      ...
      const double xi_204 = xi_203 + xia_11_collide + xia_20_collide;
      const double xi_296 = -xia_11_collide - xia_20_collide;
      const double xia_21_collide = _data_phasefield[_stride_phasefield_0*ctr_0 + _stride_phasefield_1*ctr_1 + _stride_phasefield_2*ctr_2];
      const bool xi_0 = xia_21_collide > 0.5;
      const bool xi_1 = xia_21_collide < -0.5;
      const double xi_10 = xia_21_collide*xia_21_collide;
      const bool xi_11 = xia_21_collide > 0.0;
      const double xi_14 = ((xi_0) ? (omega_shear_a): ((xi_1) ? (omega_shear_b): ((xi_11) ? (xi_10*xi_8 + xi_5 + xi_9*xia_21_collide): (xi_10*xi_13 + xi_13*xia_21_collide + xi_5))));
      const double xi_15 = ((1.0) / (xi_14*-0.25 + 2.0));
      const double xia_22_collide = _data_velocity[_stride_velocity_0*ctr_0 + _stride_velocity_1*ctr_1 + _stride_velocity_2*ctr_2 + 2*_stride_velocity_3];
      ...
      const double xi_302 = -xia_23_collide;
      const double xi_303 = xi_302 + xia_9_collide;
      const double xi_365 = xi_200 + xi_302 + xi_312;
      const double xi_366 = -xi_328 - xi_365 - xia_12_collide;
      const double xi_368 = -xi_207 - xi_208 + xi_209 + xi_329 + xi_365 + xia_6_collide;
      ...
      const double xi_350 = -xia_24_collide;
      ...
      const double xi_285 = -xia_25_collide;
      const double xi_304 = xi_285 + xia_13_collide;
      const double xi_305 = -xi_301 - xi_303 - xi_304 - xia_19_collide;
      const double xi_316 = -xi_304 - xi_312 - xi_313 - xi_314 - xi_315 + xia_20_collide*2.0 - xia_23_collide;
      const double xia_26_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2];
      const double xi_192 = xia_12_collide*3.0 + xia_13_collide*3.0 + xia_19_collide*-3.0 + xia_23_collide*-3.0 + xia_25_collide*3.0 - xia_26_collide + xia_6_collide*3.0 + xia_8_collide*-3.0 + xia_9_collide*-3.0;
      const double xi_194 = -xia_26_collide;
      const double xia_27_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 3*_stride_pdfs_a_3];
      const double xi_195 = xi_194 + xia_19_collide*2.0 + xia_23_collide*2.0 + xia_24_collide*5.0 + xia_27_collide*5.0 + xia_8_collide*2.0 + xia_9_collide*2.0;
      const double xi_196 = xi_195 + xia_10_collide*-5.0 + xia_12_collide*3.0 + xia_13_collide*-2.0 + xia_14_collide*-5.0 + xia_16_collide*-5.0 + xia_25_collide*-2.0 + xia_5_collide*-5.0 + xia_6_collide*3.0;
      const double xi_210 = xi_195 + xi_207 + xi_208 + xi_209 + xia_11_collide*-7.0 + xia_12_collide*-4.0 + xia_13_collide*5.0 + xia_17_collide*-7.0 + xia_20_collide*-7.0 + xia_25_collide*5.0 + xia_4_collide*-7.0 + xia_6_collide*-4.0;
      const double xi_353 = -xi_350 - xi_352 - xia_27_collide;
      const double xi_355 = -xi_313 + xi_315 + xi_352 + xia_20_collide*2.0 + xia_24_collide - xia_27_collide;
      const double xia_28_collide = _data_force_a[_stride_force_a_0*ctr_0 + _stride_force_a_1*ctr_1 + _stride_force_a_2*ctr_2 + _stride_force_a_3];
      const double xi_28 = xia_28_collide*0.083333333333333329;
      const double xi_61 = xia_28_collide*0.25;
      const double xia_29_collide = _data_force_a[_stride_force_a_0*ctr_0 + _stride_force_a_1*ctr_1 + _stride_force_a_2*ctr_2];
      const double xi_43 = xia_29_collide*0.083333333333333329;
      ...
      const double xi_21 = ((xi_0) ? (omega_shear_a): ((xi_1) ? (omega_shear_b): ((xi_11) ? (xi_10*xi_19 + xi_17 - xi_19*xia_21_collide): (xi_10*xi_20 + xi_17 + xi_20*xia_21_collide))));
      const double rr_0_a_collide = 0.0;
      const double xi_29 = rr_0_a_collide*xi_28 + xia_28_collide*-0.16666666666666666;
      const double xi_44 = rr_0_a_collide*xi_43 + xia_29_collide*-0.16666666666666666;
      const double xi_53 = rr_0_a_collide*xi_52 + xia_3_collide*-0.16666666666666666;
      const double xi_56 = rr_0_a_collide*0.041666666666666664;
      const double xi_57 = xi_56*xia_29_collide;
      const double xi_58 = -xi_28 + xi_56*xia_28_collide;
      const double xi_59 = xi_43 - xi_57 + xi_58;
      const double xi_71 = -xi_43 + xi_57;
      const double xi_72 = xi_58 + xi_71;
      const double xi_76 = xi_56*xia_3_collide;
      ...
      const double xi_66 = xi_65*xia_28_collide;
      ...
      const double xi_452 = xi_353*xi_416;
      ...
      const double xi_360 = xi_306*xi_353 + xi_311*xi_354 + xi_359;
      ...
      const double xi_454 = xi_354*xi_421;
      ...
      const double xi_22 = u_0_a_collide*xia_29_collide;
      ...
      const double xi_90 = u_0_a_collide*xia_3_collide;
      const double xi_91 = xi_90*0.25;
      const double xi_94 = xi_65*xi_90;
      const double xi_198 = u_0_a_collide*u_0_a_collide;
      const double u_1_a_collide = xia_15_collide;
      const double xi_23 = u_1_a_collide*xia_28_collide;
      ...
      const double xi_64 = xi_63*xia_29_collide;
      const double xi_68 = u_1_a_collide*xi_65;
      const double xi_69 = xi_68*xia_29_collide;
      const double xi_70 = xi_62 + xi_64 - xi_67 - xi_69;
      const double xi_73 = -xi_62 - xi_64 + xi_67 + xi_69;
      const double xi_80 = xi_63*xia_3_collide;
      const double xi_82 = xi_68*xia_3_collide;
      const double xi_199 = rho_a_collide*(u_1_a_collide*u_1_a_collide);
      const double xi_297 = xi_199 + xi_285 - xia_13_collide;
      ...
      const double u_2_a_collide = xia_22_collide;
      const double xi_24 = u_2_a_collide*xia_3_collide;
      ...
      const double xi_60 = rr_1_a_collide*u_2_a_collide*xia_3_collide*-0.041666666666666664 + xi_31 + xi_55;
      const double xi_75 = xi_24*xi_74 - xi_31 + xi_54;
      const double xi_79 = rr_1_a_collide*u_0_a_collide*xia_29_collide*-0.041666666666666664 + xi_35 + xi_48;
      ...
      const double xi_92 = u_2_a_collide*xia_29_collide;
      const double xi_93 = xi_92*0.25;
      const double xi_95 = xi_65*xi_92;
      const double xi_96 = -xi_91 - xi_93 + xi_94 + xi_95;
      const double xi_98 = rr_1_a_collide*u_1_a_collide*xia_28_collide*-0.041666666666666664 + xi_41 + xi_45;
      ...
      const double xi_202 = -xi_201 + xia_10_collide + xia_14_collide + xia_16_collide + xia_5_collide;
      const double xi_205 = rho_a_collide*xi_198 - xi_194 + xi_199 - xi_200 - xi_202 - xi_204 - xia_23_collide - xia_9_collide;
      const double xi_206 = rr_1_a_collide*xi_205;
      const double xi_298 = rr_1_a_collide*(xi_202 + xi_296 + xi_297 + xia_12_collide - xia_17_collide - xia_4_collide + xia_6_collide);
      const double xi_299 = xi_298*0.125;
      const double xi_300 = -xi_295 - xi_299;
      const double xi_330 = rho_a_collide*xi_198*2.0 - xi_201 - xi_204 - xi_297 - xi_328 - xi_329 - xia_10_collide - xia_14_collide - xia_16_collide + xia_19_collide*2.0 + xia_23_collide*2.0 + xia_24_collide*-2.0 + xia_27_collide*-2.0 - xia_5_collide + xia_8_collide*2.0 + xia_9_collide*2.0;
      ...
      const double xi_450 = xi_394*(rho_a_collide*u_0_a_collide*u_2_a_collide + xi_351 - xia_16_collide + xia_5_collide);
      ...
      const double forceTerm_1_a_collide = u_1_a_collide*xia_28_collide*0.33333333333333331 - xi_27 - xi_29 - xi_38;
      ...
      const double forceTerm_4_a_collide = u_0_a_collide*xia_29_collide*0.33333333333333331 - xi_42 - xi_44 - xi_50;
      const double forceTerm_5_a_collide = u_2_a_collide*xia_3_collide*0.33333333333333331 - xi_51 - xi_53 - xi_54;
      ...
      const double xib_3_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 9*_stride_pdfs_b_3];
      const double xib_4_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 10*_stride_pdfs_b_3];
      ...
      const double xi_484 = xib_5_collide*2.0;
      ...
      const double xi_507 = -xib_6_collide;
      ...
      const double xi_565 = -xib_7_collide;
      const double xib_8_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 8*_stride_pdfs_b_3];
      const double xi_506 = -xib_3_collide - xib_8_collide;
      const double xi_520 = xib_8_collide*2.0;
      ...
      const double xi_470 = -xib_10_collide;
      const double xib_11_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 12*_stride_pdfs_b_3];
      const double xib_12_collide = _data_velocity[_stride_velocity_0*ctr_0 + _stride_velocity_1*ctr_1 + _stride_velocity_2*ctr_2 + _stride_velocity_3];
      const double xib_13_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 18*_stride_pdfs_b_3];
      const double xib_14_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 15*_stride_pdfs_b_3];
      const double xi_512 = -xib_14_collide;
      ...
      const double xi_152 = xib_15_collide*0.25;
      const double xib_16_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 17*_stride_pdfs_b_3];
      const double xi_485 = xib_13_collide*2.0 + xib_16_collide*2.0;
      const double xi_553 = xib_13_collide - xib_16_collide;
      const double xib_17_collide = _data_force_b[_stride_force_b_0*ctr_0 + _stride_force_b_1*ctr_1 + _stride_force_b_2*ctr_2];
      const double xi_134 = xib_17_collide*0.083333333333333329;
      const double xib_18_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 4*_stride_pdfs_b_3];
      const double xi_552 = -xib_18_collide;
      const double xib_19_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 13*_stride_pdfs_b_3];
      const double xi_483 = xib_19_collide*2.0;
      const double xi_554 = xi_553 - xib_19_collide + xib_5_collide;
      const double xib_20_collide = _data_phasefield[_stride_phasefield_0*ctr_0 + _stride_phasefield_1*ctr_1 + _stride_phasefield_2*ctr_2];
      const bool xi_101 = xib_20_collide > 0.5;
      const bool xi_102 = xib_20_collide < -0.5;
      const double xi_103 = xib_20_collide*xib_20_collide;
      const bool xi_104 = xib_20_collide > 0.0;
      const double xi_105 = ((xi_101) ? (omega_shear_a): ((xi_102) ? (omega_shear_b): ((xi_104) ? (xi_103*xi_8 + xi_5 + xi_9*xib_20_collide): (xi_103*xi_13 + xi_13*xib_20_collide + xi_5))));
      const double xi_106 = ((1.0) / (xi_105*-0.25 + 2.0));
      const double xib_21_collide = _data_velocity[_stride_velocity_0*ctr_0 + _stride_velocity_1*ctr_1 + _stride_velocity_2*ctr_2 + 2*_stride_velocity_3];
      const double xib_22_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 3*_stride_pdfs_b_3];
      const double xi_555 = -xi_552 - xi_554 - xib_22_collide;
      ...
      const double xi_479 = xib_23_collide + xib_4_collide;
      const double xi_480 = xi_479 + xib_3_collide + xib_8_collide;
      const double xi_521 = xib_23_collide*2.0 + xib_4_collide*-2.0;
      const double xi_557 = -xi_520 + xi_521 + xi_554 + xib_18_collide - xib_22_collide + xib_3_collide*2.0;
      ...
      const double xi_471 = xi_470 + xib_11_collide*2.0 + xib_14_collide*2.0 + xib_18_collide*5.0 + xib_22_collide*5.0 + xib_24_collide*2.0 + xib_7_collide*2.0;
      const double xi_476 = xib_11_collide + xib_24_collide;
      const double xi_513 = xib_11_collide - xib_24_collide;
      const double xi_514 = xi_512 + xi_513 + xib_7_collide;
      const double xi_566 = xi_476 + xi_512 + xi_565;
      const double xib_25_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + _stride_pdfs_b_3];
      const double xi_498 = -xib_25_collide;
      const double xi_515 = xi_507 + xi_514 + xib_25_collide;
      const double xi_522 = -xi_498 - xi_514 - xi_520 - xi_521 + xib_3_collide*2.0 - xib_6_collide;
      const double xib_26_collide = _data_force_b[_stride_force_b_0*ctr_0 + _stride_force_b_1*ctr_1 + _stride_force_b_2*ctr_2 + 2*_stride_force_b_3];
      const double xi_143 = xib_26_collide*0.083333333333333329;
      const double xib_27_collide = _data_rho_b[_stride_rho_b_0*ctr_0 + _stride_rho_b_1*ctr_1 + _stride_rho_b_2*ctr_2];
      const double xib_28_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 5*_stride_pdfs_b_3];
      const double xi_534 = -xib_28_collide;
      const double xib_29_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 6*_stride_pdfs_b_3];
      const double xi_468 = -xib_10_collide + xib_11_collide*-3.0 + xib_14_collide*-3.0 + xib_24_collide*-3.0 + xib_25_collide*3.0 + xib_28_collide*3.0 + xib_29_collide*3.0 + xib_6_collide*3.0 + xib_7_collide*-3.0;
      const double xi_472 = xi_471 + xib_13_collide*-5.0 + xib_16_collide*-5.0 + xib_19_collide*-5.0 + xib_25_collide*-2.0 + xib_28_collide*3.0 + xib_29_collide*3.0 + xib_5_collide*-5.0 + xib_6_collide*-2.0;
      const double xi_486 = xi_471 + xi_483 + xi_484 + xi_485 + xib_23_collide*-7.0 + xib_25_collide*5.0 + xib_28_collide*-4.0 + xib_29_collide*-4.0 + xib_3_collide*-7.0 + xib_4_collide*-7.0 + xib_6_collide*5.0 + xib_8_collide*-7.0;
      const double xi_535 = -xib_29_collide;
      const double xi_567 = -xi_534 - xi_566 - xib_29_collide;
      const double xi_569 = -xi_483 - xi_484 + xi_485 + xi_535 + xi_566 + xib_28_collide;
      ...
      const double xi_112 = ((xi_101) ? (omega_shear_a): ((xi_102) ? (omega_shear_b): ((xi_104) ? (xi_103*xi_110 + xi_108 - xi_110*xib_20_collide): (xi_103*xi_111 + xi_108 + xi_111*xib_20_collide))));
      const double rr_0_b_collide = 0.0;
      const double xi_120 = rr_0_b_collide*xi_119 + xib_15_collide*-0.16666666666666666;
      const double xi_135 = rr_0_b_collide*xi_134 + xib_17_collide*-0.16666666666666666;
      const double xi_144 = rr_0_b_collide*xi_143 + xib_26_collide*-0.16666666666666666;
      const double xi_147 = rr_0_b_collide*0.041666666666666664;
      const double xi_148 = xi_147*xib_17_collide;
      const double xi_149 = -xi_119 + xi_147*xib_15_collide;
      const double xi_150 = xi_134 - xi_148 + xi_149;
      const double xi_162 = -xi_134 + xi_148;
      const double xi_163 = xi_149 + xi_162;
      const double xi_167 = xi_147*xib_26_collide;
      const double xi_168 = -xi_143 + xi_167;
      const double xi_169 = xi_149 + xi_168;
      const double xi_176 = xi_143 - xi_167;
      const double xi_177 = xi_149 + xi_176;
      const double xi_179 = xi_162 + xi_176;
      const double xi_188 = xi_162 + xi_168;
      const double rr_1_b_collide = xi_112;
      const double xi_116 = rr_1_b_collide*0.5;
      const double xi_156 = rr_1_b_collide*0.125;
      const double xi_157 = xi_156*xib_15_collide;
      const double xi_165 = rr_1_b_collide*0.041666666666666664;
      const double xi_469 = rr_1_b_collide*xi_468;
      const double xi_473 = rr_1_b_collide*xi_472;
      const double xi_487 = rr_1_b_collide*xi_486;
      const double xi_499 = xi_487*0.01984126984126984;
      const double xi_531 = xi_469*0.050000000000000003;
      const double xi_549 = xi_473*0.035714285714285712;
      const double xi_563 = xi_473*0.021428571428571429;
      const double xi_577 = xi_487*0.013888888888888888;
      const double xi_585 = rr_1_b_collide*0.25;
      const double xi_606 = xi_473*0.0071428571428571426;
      const double xi_608 = xi_487*0.003968253968253968;
      const double xi_616 = xi_473*0.017857142857142856;
      const double rr_2_b_collide = xib_0_collide*(xi_112*-2.0 + 4.0);
      const double xi_516 = rr_2_b_collide*0.25;
      const double xi_523 = rr_2_b_collide*0.083333333333333329;
      const double xi_524 = xi_522*xi_523;
      const double xi_558 = xi_523*xi_557;
      const double xi_570 = xi_523*xi_569;
      const double xi_591 = rr_2_b_collide*0.041666666666666664;
      const double xi_592 = xi_522*xi_591;
      const double xi_594 = rr_2_b_collide*0.125;
      const double xi_595 = xi_515*xi_594;
      const double xi_601 = xi_569*xi_591;
      const double xi_602 = xi_567*xi_594;
      const double xi_622 = xi_555*xi_594;
      const double xi_623 = xi_557*xi_591;
      const double rho_b_collide = xib_27_collide;
      const double xi_488 = kT*rho_b_collide;
      const double xi_489 = pow(xi_488*(1.0 - ((-xi_105 + 1.0)*(-xi_105 + 1.0))), 0.5);
      const double xi_491 = xi_489*xi_490;
      const double xi_493 = xi_489*xi_492;
      const double xi_495 = xi_223*xi_489*xi_494;
      const double xi_497 = xi_489*xi_496;
      const double xi_500 = xi_212*xi_491;
      const double xi_501 = xi_500*0.11904761904761904;
      const double xi_502 = xi_499 + xi_501;
      const double xi_504 = xi_489*0.5;
      const double xi_505 = xi_503*xi_504;
      const double xi_518 = pow(xi_488*(1.0 - ((-xi_106*(xi_105*-2.0 + 4.0) + 1.0)*(-xi_106*(xi_105*-2.0 + 4.0) + 1.0))), 0.5);
      const double xi_519 = xi_310*xi_518;
      const double xi_526 = xi_223*xi_518;
      const double xi_527 = xi_526*0.16666666666666666;
      const double xi_528 = xi_525*xi_527;
      const double xi_529 = xi_524 + xi_528;
      const double xi_530 = xi_515*xi_516 + xi_517*xi_519 + xi_529;
      const double xi_532 = xi_218*xi_493;
      const double xi_533 = xi_532*0.10000000000000001;
      const double xi_540 = xi_489*xi_539;
      const double xi_541 = xi_334*xi_540;
      const double xi_544 = xi_225*xi_497;
      const double xi_545 = -xi_499 - xi_501;
      const double xi_550 = xi_544*0.071428571428571425;
      const double xi_551 = xi_333*xi_540;
      const double xi_560 = xi_527*xi_559;
      const double xi_561 = xi_558 + xi_560;
      const double xi_562 = xi_516*xi_555 + xi_519*xi_556 + xi_561;
      const double xi_564 = xi_544*0.042857142857142858;
      const double xi_572 = xi_527*xi_571;
      const double xi_573 = xi_570 + xi_572;
      const double xi_574 = xi_516*xi_567 + xi_519*xi_568 + xi_573;
      const double xi_575 = xi_489*xi_503*0.25;
      const double xi_578 = xi_500*0.083333333333333329;
      const double xi_582 = -xi_558 - xi_560;
      const double xi_583 = xi_504*(random_9_1_shifted - 0.5);
      const double xi_590 = xi_504*(random_10_1_shifted - 0.5);
      const double xi_596 = xi_526*0.083333333333333329;
      const double xi_597 = xi_525*xi_596;
      const double xi_598 = xi_420*xi_518;
      const double xi_599 = xi_517*xi_598;
      const double xi_603 = xi_571*xi_596;
      const double xi_604 = xi_568*xi_598;
      const double xi_605 = -xi_601 + xi_602 - xi_603 + xi_604;
      const double xi_607 = xi_544*0.014285714285714285;
      const double xi_609 = xi_500*0.023809523809523808;
      const double xi_610 = -xi_608 - xi_609;
      const double xi_612 = xi_601 - xi_602 + xi_603 - xi_604;
      const double xi_614 = -xi_575;
      const double xi_617 = xi_544*0.035714285714285712;
      const double xi_619 = xi_504*(random_10_0_shifted - 0.5);
      const double xi_624 = xi_556*xi_598;
      const double xi_625 = xi_559*xi_596;
      ...
      const double xi_113 = u_0_b_collide*xib_17_collide;
      ...
      const double xi_181 = u_0_b_collide*xib_26_collide;
      const double xi_182 = xi_181*0.25;
      const double xi_185 = xi_156*xi_181;
      const double xi_474 = u_0_b_collide*u_0_b_collide;
      const double u_1_b_collide = xib_12_collide;
      const double xi_114 = u_1_b_collide*xib_15_collide;
      ...
      const double xi_155 = xi_154*xib_17_collide;
      const double xi_159 = u_1_b_collide*xi_156;
      const double xi_160 = xi_159*xib_17_collide;
      const double xi_161 = xi_153 + xi_155 - xi_158 - xi_160;
      const double xi_164 = -xi_153 - xi_155 + xi_158 + xi_160;
      const double xi_171 = xi_154*xib_26_collide;
      const double xi_173 = xi_159*xib_26_collide;
      const double xi_475 = rho_b_collide*(u_1_b_collide*u_1_b_collide);
      const double xi_508 = xi_475 + xi_498 + xi_507;
      const double xi_584 = rho_b_collide*u_1_b_collide;
      const double xi_586 = xi_585*(u_0_b_collide*xi_584 + xi_479 + xi_506);
      const double xi_587 = -xi_583 - xi_586;
      const double xi_588 = xi_583 + xi_586;
      const double u_2_b_collide = xib_21_collide;
      const double xi_115 = u_2_b_collide*xib_26_collide;
      ...
      const double xi_151 = rr_1_b_collide*u_2_b_collide*xib_26_collide*-0.041666666666666664 + xi_122 + xi_146;
      const double xi_166 = xi_115*xi_165 - xi_122 + xi_145;
      const double xi_170 = rr_1_b_collide*u_0_b_collide*xib_17_collide*-0.041666666666666664 + xi_126 + xi_139;
      const double xi_172 = u_2_b_collide*xi_152;
      const double xi_174 = u_2_b_collide*xi_157;
      const double xi_175 = -xi_171 - xi_172 + xi_173 + xi_174;
      const double xi_178 = xi_113*xi_165 - xi_126 + xi_141;
      const double xi_180 = xi_114*xi_165 + xi_129 - xi_136;
      const double xi_183 = u_2_b_collide*xib_17_collide;
      const double xi_184 = xi_183*0.25;
      const double xi_186 = xi_156*xi_183;
      const double xi_187 = -xi_182 - xi_184 + xi_185 + xi_186;
      const double xi_189 = rr_1_b_collide*u_1_b_collide*xib_15_collide*-0.041666666666666664 + xi_132 + xi_136;
      const double xi_190 = xi_171 + xi_172 - xi_173 - xi_174;
      const double xi_191 = xi_182 + xi_184 - xi_185 - xi_186;
      const double xi_477 = rho_b_collide*(u_2_b_collide*u_2_b_collide);
      const double xi_478 = -xi_477 + xib_13_collide + xib_16_collide + xib_19_collide + xib_5_collide;
      const double xi_481 = rho_b_collide*xi_474 - xi_470 + xi_475 - xi_476 - xi_478 - xi_480 - xib_14_collide - xib_7_collide;
      const double xi_482 = rr_1_b_collide*xi_481;
      const double xi_509 = rr_1_b_collide*(xi_478 + xi_506 + xi_508 - xib_23_collide + xib_28_collide + xib_29_collide - xib_4_collide);
      const double xi_510 = xi_509*0.125;
      const double xi_511 = -xi_505 - xi_510;
      const double xi_536 = rho_b_collide*xi_474*2.0 - xi_477 - xi_480 - xi_508 - xi_534 - xi_535 + xib_11_collide*2.0 - xib_13_collide + xib_14_collide*2.0 - xib_16_collide + xib_18_collide*-2.0 - xib_19_collide + xib_22_collide*-2.0 + xib_24_collide*2.0 - xib_5_collide + xib_7_collide*2.0;
      const double xi_537 = rr_1_b_collide*xi_536;
      const double xi_538 = xi_537*0.041666666666666664;
      const double xi_542 = xi_538 + xi_541;
      const double xi_543 = xi_531 + xi_533 + xi_542;
      const double xi_546 = xi_505 + xi_510;
      const double xi_547 = -xi_538 - xi_541;
      const double xi_548 = -xi_531 - xi_533 + xi_547;
      const double xi_576 = xi_509*0.0625;
      const double xi_579 = xi_482*0.041666666666666664 + xi_495*0.083333333333333329;
      const double xi_580 = xi_537*0.020833333333333332 + xi_551*0.083333333333333329 + xi_579;
      const double xi_581 = xi_529 + xi_575 + xi_576 + xi_577 + xi_578 + xi_580;
      const double xi_589 = -xi_524 - xi_528 + xi_575 + xi_576 + xi_577 + xi_578 + xi_580;
      const double xi_593 = xi_585*(u_2_b_collide*xi_584 + xi_513 + xi_565 + xib_14_collide);
      const double xi_600 = xi_590 - xi_592 + xi_593 + xi_595 - xi_597 + xi_599;
      const double xi_611 = xi_469*0.025000000000000001 + xi_532*0.050000000000000003 + xi_547 + xi_579 - xi_606 - xi_607 + xi_610;
      const double xi_613 = rr_1_b_collide*xi_468*-0.025000000000000001 + rr_1_b_collide*xi_481*-0.041666666666666664 + xi_218*xi_489*xi_492*-0.050000000000000003 + xi_223*xi_489*xi_494*-0.083333333333333329 + xi_542 + xi_606 + xi_607 + xi_608 + xi_609;
      const double xi_615 = -xi_576;
      const double xi_618 = xi_573 + xi_580 + xi_610 + xi_614 + xi_615 + xi_616 + xi_617;
      const double xi_620 = xi_585*(rho_b_collide*u_0_b_collide*u_2_b_collide + xi_553 + xib_19_collide - xib_5_collide);
      ...
      const double forceTerm_1_b_collide = u_1_b_collide*xib_15_collide*0.33333333333333331 - xi_118 - xi_120 - xi_129;
      ...
      const double forceTerm_4_b_collide = u_0_b_collide*xib_17_collide*0.33333333333333331 - xi_133 - xi_135 - xi_141;
      const double forceTerm_5_b_collide = u_2_b_collide*xib_26_collide*0.33333333333333331 - xi_142 - xi_144 - xi_145;
      const double forceTerm_6_b_collide = xi_115*0.33333333333333331 - xi_142 + xi_144 + xi_146;
      const double forceTerm_7_b_collide = -xi_150 - xi_151 - xi_161;
      const double forceTerm_8_b_collide = -xi_151 - xi_163 - xi_164;
      const double forceTerm_9_b_collide = xi_161 + xi_163 + xi_166;
      const double forceTerm_10_b_collide = xi_150 + xi_164 + xi_166;
      const double forceTerm_11_b_collide = -xi_169 - xi_170 - xi_175;
      const double forceTerm_12_b_collide = xi_175 + xi_177 + xi_178;
      const double forceTerm_13_b_collide = xi_179 + xi_180 + xi_187;
      const double forceTerm_14_b_collide = -xi_187 - xi_188 - xi_189;
      const double forceTerm_15_b_collide = -xi_170 - xi_177 - xi_190;
      const double forceTerm_16_b_collide = xi_169 + xi_178 + xi_190;
      const double forceTerm_17_b_collide = xi_180 + xi_188 + xi_191;
      const double forceTerm_18_b_collide = -xi_179 - xi_189 - xi_191;
      const double tmp_a0 = forceTerm_0_a_collide + xi_193*0.10000000000000001 + xi_197*0.042857142857142858 + xi_206*-0.5 + xi_211*0.023809523809523808 + xi_213*xi_217 + xi_219*xi_221 - xi_224 + xi_226*xi_228 + xi_284 + xia_26_collide;
      ...
      const double tmp_a2 = forceTerm_2_a_collide + xi_197*0.014285714285714285 + xi_324 + xi_340*0.028571428571428571 + xi_341 + xi_342 + xi_343 + xi_345 + xia_13_collide;
      const double tmp_a3 = forceTerm_3_a_collide + xi_331*0.083333333333333329 + xi_342 - xi_346 - xi_347 + xi_348*0.33333333333333331 + xi_349 + xi_360 + xia_27_collide;
      const double tmp_a4 = forceTerm_4_a_collide + rr_1_a_collide*xi_330*0.083333333333333329 + xi_215*xi_333*xi_335*0.33333333333333331 - xi_292 - xi_346 - xi_347 - xi_350 - xi_360 - xi_361;
      ...
      const double tmp_a6 = forceTerm_6_a_collide + xi_211*0.015873015873015872 + xi_290*0.095238095238095233 + xi_300 + xi_345 - xi_363 - xi_364 + xi_373 + xi_374 + xia_12_collide;
      const double tmp_a7 = forceTerm_7_a_collide + xi_383 + xi_390 + xi_391 + xi_396 + xia_4_collide;
      const double tmp_a8 = forceTerm_8_a_collide + xi_359 + xi_390 + xi_402 + xi_403 + xia_11_collide;
      const double tmp_a9 = forceTerm_9_a_collide + xi_391 + xi_403 + xi_404 + xi_405 + xia_20_collide;
      const double tmp_a10 = forceTerm_10_a_collide + xi_359 + xi_396 + xi_405 + xi_406 + xia_17_collide;
      const double tmp_a11 = forceTerm_11_a_collide + xi_411 + xi_423 + xi_428 + xi_434 + xia_19_collide;
      const double tmp_a12 = forceTerm_12_a_collide - xi_301 - xi_423 - xi_438 - xi_439 - xi_440;
      const double tmp_a13 = forceTerm_13_a_collide + xi_443 + xi_448 + xi_451 + xi_456 + xia_5_collide;
      const double tmp_a14 = forceTerm_14_a_collide + xi_448 + xi_459 + xi_460 + xi_461 + xia_16_collide;
      const double tmp_a15 = forceTerm_15_a_collide - xi_312 - xi_428 - xi_440 - xi_462 - xi_463;
      const double tmp_a16 = forceTerm_16_a_collide + xi_434 + xi_439 + xi_463 + xi_464 + xia_23_collide;
      const double tmp_a17 = forceTerm_17_a_collide + xi_456 + xi_460 + xi_465 + xi_466 + xia_14_collide;
      const double tmp_a18 = forceTerm_18_a_collide + xi_451 + xi_461 + xi_466 + xi_467 + xia_10_collide;
      const double tmp_b0 = forceTerm_0_b_collide + xi_213*xi_491 + xi_219*xi_493 + xi_226*xi_497 + xi_284 + xi_469*0.10000000000000001 + xi_473*0.042857142857142858 + xi_482*-0.5 + xi_487*0.023809523809523808 - xi_495 + xib_10_collide;
      const double tmp_b1 = forceTerm_1_b_collide + rr_1_b_collide*xi_472*0.014285714285714285 + xi_225*xi_489*xi_496*0.028571428571428571 - xi_288 - xi_498 - xi_502 - xi_511 - xi_530 - xi_543;
      const double tmp_b2 = forceTerm_2_b_collide + xi_341 + xi_473*0.014285714285714285 + xi_530 + xi_544*0.028571428571428571 + xi_545 + xi_546 + xi_548 + xib_6_collide;
      const double tmp_b3 = forceTerm_3_b_collide + xi_349 + xi_537*0.083333333333333329 + xi_545 - xi_549 - xi_550 + xi_551*0.33333333333333331 + xi_562 + xib_22_collide;
      const double tmp_b4 = forceTerm_4_b_collide + rr_1_b_collide*xi_536*0.083333333333333329 + xi_333*xi_489*xi_539*0.33333333333333331 - xi_361 - xi_502 - xi_549 - xi_550 - xi_552 - xi_562;
      const double tmp_b5 = forceTerm_5_b_collide + rr_1_b_collide*xi_486*0.015873015873015872 + xi_212*xi_489*xi_490*0.095238095238095233 - xi_362 - xi_534 - xi_543 - xi_546 - xi_563 - xi_564 - xi_574;
      const double tmp_b6 = forceTerm_6_b_collide + xi_374 + xi_487*0.015873015873015872 + xi_500*0.095238095238095233 + xi_511 + xi_548 - xi_563 - xi_564 + xi_574 + xib_29_collide;
      const double tmp_b7 = forceTerm_7_b_collide + xi_383 + xi_581 + xi_582 + xi_587 + xib_23_collide;
      const double tmp_b8 = forceTerm_8_b_collide + xi_402 + xi_561 + xi_581 + xi_588 + xib_8_collide;
      const double tmp_b9 = forceTerm_9_b_collide + xi_404 + xi_582 + xi_588 + xi_589 + xib_3_collide;
      const double tmp_b10 = forceTerm_10_b_collide + xi_406 + xi_561 + xi_587 + xi_589 + xib_4_collide;
      const double tmp_b11 = forceTerm_11_b_collide + xi_411 + xi_600 + xi_605 + xi_611 + xib_24_collide;
      const double tmp_b12 = forceTerm_12_b_collide - xi_438 - xi_600 - xi_612 - xi_613 + xib_11_collide;
      const double tmp_b13 = forceTerm_13_b_collide + xi_443 + xi_618 + xi_621 + xi_626 + xib_19_collide;
      const double tmp_b14 = forceTerm_14_b_collide + xi_459 + xi_618 + xi_627 + xi_628 + xib_5_collide;
      const double tmp_b15 = forceTerm_15_b_collide - xi_462 - xi_512 - xi_605 - xi_613 - xi_629;
      const double tmp_b16 = forceTerm_16_b_collide + xi_464 + xi_611 + xi_612 + xi_629 + xib_7_collide;
      const double tmp_b17 = forceTerm_17_b_collide + xi_465 + xi_626 + xi_627 + xi_630 + xib_16_collide;
      const double tmp_b18 = forceTerm_18_b_collide + xi_467 + xi_621 + xi_628 + xi_630 + xib_13_collide;
