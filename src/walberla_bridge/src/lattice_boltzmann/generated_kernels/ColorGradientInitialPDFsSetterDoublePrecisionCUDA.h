...
public:
  ColorGradientInitialPDFsSetterDoublePrecisionCUDA(
  ...
  getSweep(const shared_ptr<ColorGradientInitialPDFsSetterDoublePrecisionCUDA>
               &kernel) {
    return [kernel](IBlock *b) { kernel->run(b); };
  }

  static std::function<void(IBlock *, gpuStream_t)> getSweepOnCellInterval(
      const shared_ptr<ColorGradientInitialPDFsSetterDoublePrecisionCUDA>
          &kernel,
