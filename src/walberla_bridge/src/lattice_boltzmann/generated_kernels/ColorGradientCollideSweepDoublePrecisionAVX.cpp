         ...
         {
            {
               for (int64_t ctr_0 = 1; ctr_0 < (int64_t)((_size_force_a_0 - 2) / (4)) * (4) + 1; ctr_0 += 4)
               {
                  ...
                  const __m256d xia_2_collide = _mm256_loadu_pd(& _data_force_a[_stride_force_a_1*ctr_1 + _stride_force_a_2*ctr_2 + 2*_stride_force_a_3 + ctr_0]);
                  const __m256d xi_26 = _mm256_mul_pd(xia_2_collide,_mm256_set_pd(0.16666666666666666,0.16666666666666666,0.16666666666666666,0.16666666666666666));
                  const __m256d xi_28 = _mm256_mul_pd(xi_26,_mm256_set_pd(omega_odd_a,omega_odd_a,omega_odd_a,omega_odd_a));
                  const __m256d xi_55 = _mm256_mul_pd(xia_2_collide,_mm256_set_pd(0.083333333333333329,0.083333333333333329,0.083333333333333329,0.083333333333333329));
                  const __m256d xi_56 = _mm256_mul_pd(xia_2_collide,_mm256_set_pd(xi_33,xi_33,xi_33,xi_33));
                  ...
                  const __m256d xia_3_collide = _mm256_load_pd(& _data_pdfs_a[_stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 4*_stride_pdfs_a_3 + ctr_0]);
                  const __m256d xia_4_collide = _mm256_loadu_pd(& _data_force_a[_stride_force_a_1*ctr_1 + _stride_force_a_2*ctr_2 + _stride_force_a_3 + ctr_0]);
                  const __m256d xi_4 = _mm256_mul_pd(xia_4_collide,_mm256_set_pd(0.16666666666666666,0.16666666666666666,0.16666666666666666,0.16666666666666666));
                  const __m256d xi_7 = _mm256_mul_pd(xi_4,_mm256_set_pd(omega_odd_a,omega_odd_a,omega_odd_a,omega_odd_a));
                  const __m256d xi_37 = _mm256_mul_pd(xia_4_collide,_mm256_set_pd(0.083333333333333329,0.083333333333333329,0.083333333333333329,0.083333333333333329));
                  const __m256d xi_38 = _mm256_mul_pd(xia_4_collide,_mm256_set_pd(xi_33,xi_33,xi_33,xi_33));
                  const __m256d xi_39 = _mm256_add_pd(_mm256_mul_pd(xi_37,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0)),xi_38);
                  const __m256d xi_41 = _mm256_mul_pd(xia_4_collide,_mm256_set_pd(0.25,0.25,0.25,0.25));
                  const __m256d xi_46 = _mm256_mul_pd(xia_4_collide,_mm256_set_pd(xi_45,xi_45,xi_45,xi_45));
                  const __m256d xi_53 = _mm256_add_pd(_mm256_mul_pd(xi_38,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0)),xi_37);
                  const __m256d xia_5_collide = _mm256_loadu_pd(& _data_pdfs_a[_stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 6*_stride_pdfs_a_3 + ctr_0]);
                  const __m256d xia_6_collide = _mm256_load_pd(& _data_velocity[_stride_velocity_1*ctr_1 + _stride_velocity_2*ctr_2 + ctr_0]);
                  const __m256d xia_7_collide = _mm256_load_pd(& _data_pdfs_a[_stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 16*_stride_pdfs_a_3 + ctr_0]);
                  const __m256d xi_254 = _mm256_add_pd(xi_253,xia_7_collide);
                  const __m256d xia_8_collide = _mm256_loadu_pd(& _data_velocity[_stride_velocity_1*ctr_1 + _stride_velocity_2*ctr_2 + _stride_velocity_3 + ctr_0]);
                  const __m256d xia_9_collide = _mm256_loadu_pd(& _data_pdfs_a[_stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 14*_stride_pdfs_a_3 + ctr_0]);
                  const __m256d xi_265 = _mm256_mul_pd(xia_9_collide,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0));
                  const __m256d xia_10_collide = _mm256_loadu_pd(& _data_pdfs_a[_stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 17*_stride_pdfs_a_3 + ctr_0]);
                  const __m256d xi_266 = _mm256_add_pd(xi_265,xia_10_collide);
                  const __m256d xia_11_collide = _mm256_load_pd(& _data_force_a[_stride_force_a_1*ctr_1 + _stride_force_a_2*ctr_2 + ctr_0]);
                  const __m256d xi_17 = _mm256_mul_pd(xia_11_collide,_mm256_set_pd(0.16666666666666666,0.16666666666666666,0.16666666666666666,0.16666666666666666));
                  const __m256d xi_18 = _mm256_mul_pd(xi_17,_mm256_set_pd(omega_odd_a,omega_odd_a,omega_odd_a,omega_odd_a));
                  const __m256d xi_32 = _mm256_mul_pd(xia_11_collide,_mm256_set_pd(0.083333333333333329,0.083333333333333329,0.083333333333333329,0.083333333333333329));
                  const __m256d xi_34 = _mm256_mul_pd(xia_11_collide,_mm256_set_pd(xi_33,xi_33,xi_33,xi_33));
                  ...
                  const __m256d xia_12_collide = _mm256_load_pd(& _data_rho_a[_stride_rho_a_1*ctr_1 + _stride_rho_a_2*ctr_2 + ctr_0]);
                  const __m256d xia_13_collide = _mm256_loadu_pd(& _data_pdfs_a[_stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 15*_stride_pdfs_a_3 + ctr_0]);
                  const __m256d xia_14_collide = _mm256_loadu_pd(& _data_pdfs_a[_stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 9*_stride_pdfs_a_3 + ctr_0]);
                  const __m256d xia_15_collide = _mm256_load_pd(& _data_pdfs_a[_stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 12*_stride_pdfs_a_3 + ctr_0]);
                  const __m256d xi_170 = _mm256_add_pd(xia_13_collide,xia_15_collide);
                  const __m256d xi_171 = _mm256_add_pd(_mm256_add_pd(xi_170,xia_1_collide),xia_7_collide);
                  const __m256d xia_16_collide = _mm256_loadu_pd(& _data_pdfs_a[_stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 18*_stride_pdfs_a_3 + ctr_0]);
                  const __m256d xia_17_collide = _mm256_loadu_pd(& _data_pdfs_a[_stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 2*_stride_pdfs_a_3 + ctr_0]);
                  const __m256d xia_18_collide = _mm256_loadu_pd(& _data_velocity[_stride_velocity_1*ctr_1 + _stride_velocity_2*ctr_2 + 2*_stride_velocity_3 + ctr_0]);
                  const __m256d xia_19_collide = _mm256_load_pd(& _data_pdfs_a[_stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 8*_stride_pdfs_a_3 + ctr_0]);
                  const __m256d xi_248 = _mm256_mul_pd(xia_19_collide,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0));
                  const __m256d xi_249 = _mm256_add_pd(xi_248,xia_14_collide);
                  const __m256d xia_20_collide = _mm256_loadu_pd(& _data_pdfs_a[_stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 10*_stride_pdfs_a_3 + ctr_0]);
                  const __m256d xia_21_collide = _mm256_loadu_pd(& _data_pdfs_a[_stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 5*_stride_pdfs_a_3 + ctr_0]);
                  ...
                  const __m256d xi_174 = _mm256_add_pd(xia_16_collide,xia_23_collide);
                  const __m256d xi_175 = _mm256_add_pd(_mm256_add_pd(xi_174,xia_10_collide),xia_9_collide);
                  const __m256d xia_24_collide = _mm256_load_pd(& _data_pdfs_a[_stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + ctr_0]);
                  const __m256d xia_25_collide = _mm256_loadu_pd(& _data_pdfs_a[_stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 7*_stride_pdfs_a_3 + ctr_0]);
                  const __m256d xi_177 = _mm256_add_pd(xia_20_collide,xia_25_collide);
                  const __m256d xi_178 = _mm256_add_pd(_mm256_add_pd(xi_177,xia_14_collide),xia_19_collide);
                  const __m256d xia_26_collide = _mm256_loadu_pd(& _data_pdfs_a[_stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + _stride_pdfs_a_3 + ctr_0]);
                  const __m256d xi_6 = _mm256_mul_pd(xia_4_collide,_mm256_set_pd(xi_5,xi_5,xi_5,xi_5));
                  const __m256d xi_19 = _mm256_mul_pd(xia_11_collide,_mm256_set_pd(xi_5,xi_5,xi_5,xi_5));
                  const __m256d xi_27 = _mm256_mul_pd(xia_2_collide,_mm256_set_pd(xi_5,xi_5,xi_5,xi_5));
                  const __m256d rho_a_collide = xia_12_collide;
                  ...
                  const __m256d xi_0 = _mm256_mul_pd(u_0_a_collide,xia_11_collide);
                  ...
                  const __m256d xi_73 = _mm256_mul_pd(u_0_a_collide,xia_2_collide);
                  ...
                  const __m256d xi_267 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(xia_16_collide,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0)),xi_264),xi_266),xia_23_collide);
                  const __m256d xi_268 = _mm256_mul_pd(xi_267,_mm256_set_pd(xi_251,xi_251,xi_251,xi_251));
                  const __m256d xi_269 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(xia_20_collide,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0)),xi_249),xi_264),xia_25_collide);
                  const __m256d xi_270 = _mm256_mul_pd(xi_269,_mm256_set_pd(xi_251,xi_251,xi_251,xi_251));
                  const __m256d xi_284 = _mm256_mul_pd(xi_269,_mm256_set_pd(xi_283,xi_283,xi_283,xi_283));
                  const __m256d xi_285 = _mm256_mul_pd(xi_284,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0));
                  const __m256d xi_327 = _mm256_mul_pd(xi_267,_mm256_set_pd(xi_283,xi_283,xi_283,xi_283));
                  const __m256d xi_328 = _mm256_mul_pd(xi_327,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0));
                  const __m256d u_1_a_collide = xia_8_collide;
                  const __m256d xi_1 = _mm256_mul_pd(u_1_a_collide,xia_4_collide);
                  ...
                  const __m256d xi_44 = _mm256_mul_pd(xi_43,xia_11_collide);
                  const __m256d xi_48 = _mm256_mul_pd(u_1_a_collide,_mm256_set_pd(xi_45,xi_45,xi_45,xi_45));
                  const __m256d xi_49 = _mm256_mul_pd(xi_48,xia_11_collide);
                  ...
                  const __m256d xi_63 = _mm256_mul_pd(xi_43,xia_2_collide);
                  const __m256d xi_65 = _mm256_mul_pd(xi_48,xia_2_collide);
                  const __m256d xi_71 = _mm256_mul_pd(_mm256_mul_pd(_mm256_mul_pd(u_1_a_collide,xia_4_collide),_mm256_set_pd(-0.041666666666666664,-0.041666666666666664,-0.041666666666666664,-0.041666666666666664)),_mm256_set_pd(omega_even_a,omega_even_a,omega_even_a,omega_even_a));
                  ...
                  const __m256d xi_250 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(xia_25_collide,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0)),xi_247),xi_249),xia_20_collide);
                  const __m256d xi_252 = _mm256_mul_pd(xi_250,_mm256_set_pd(xi_251,xi_251,xi_251,xi_251));
                  const __m256d xi_255 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(xia_13_collide,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0)),xi_247),xi_254),xia_15_collide);
                  ...
                  const __m256d xi_288 = _mm256_mul_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(xia_14_collide,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0)),_mm256_mul_pd(u_0_a_collide,xi_286)),xi_177),xi_248),_mm256_set_pd(xi_287,xi_287,xi_287,xi_287));
                  ...
                  const __m256d u_2_a_collide = xia_18_collide;
                  const __m256d xi_2 = _mm256_mul_pd(u_2_a_collide,xia_2_collide);
                  ...
                  const __m256d xi_36 = _mm256_mul_pd(_mm256_mul_pd(_mm256_mul_pd(u_2_a_collide,xia_2_collide),_mm256_set_pd(-0.041666666666666664,-0.041666666666666664,-0.041666666666666664,-0.041666666666666664)),_mm256_set_pd(omega_even_a,omega_even_a,omega_even_a,omega_even_a));
                  ...
                  const __m256d xi_75 = _mm256_mul_pd(u_2_a_collide,xia_11_collide);
                  ...
                  const __m256d xi_276 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(xia_23_collide,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0)),xi_266),xi_275),xia_16_collide);
                  const __m256d xi_277 = _mm256_mul_pd(xi_276,_mm256_set_pd(xi_251,xi_251,xi_251,xi_251));
                  const __m256d xi_278 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(xia_15_collide,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0)),xi_254),xi_275),xia_13_collide);
                  ...
                  const __m256d xi_312 = _mm256_mul_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(xia_7_collide,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0)),_mm256_mul_pd(u_2_a_collide,xi_286)),xi_170),xi_253),_mm256_set_pd(xi_287,xi_287,xi_287,xi_287));
                  ...
                  const __m256d xi_329 = _mm256_mul_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(xia_10_collide,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0)),_mm256_mul_pd(_mm256_mul_pd(rho_a_collide,u_0_a_collide),u_2_a_collide)),xi_174),xi_265),_mm256_set_pd(xi_287,xi_287,xi_287,xi_287));
                  ...
                  const __m256d xib_1_collide = _mm256_load_pd(& _data_pdfs_b[_stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 8*_stride_pdfs_b_3 + ctr_0]);
                  const __m256d xi_369 = _mm256_mul_pd(xib_1_collide,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0));
                  const __m256d xib_2_collide = _mm256_loadu_pd(& _data_pdfs_b[_stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 5*_stride_pdfs_b_3 + ctr_0]);
                  const __m256d xib_3_collide = _mm256_load_pd(& _data_velocity[_stride_velocity_1*ctr_1 + _stride_velocity_2*ctr_2 + ctr_0]);
                  const __m256d xib_4_collide = _mm256_loadu_pd(& _data_velocity[_stride_velocity_1*ctr_1 + _stride_velocity_2*ctr_2 + _stride_velocity_3 + ctr_0]);
                  const __m256d xib_5_collide = _mm256_loadu_pd(& _data_pdfs_b[_stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 18*_stride_pdfs_b_3 + ctr_0]);
                  const __m256d xib_6_collide = _mm256_loadu_pd(& _data_pdfs_b[_stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 3*_stride_pdfs_b_3 + ctr_0]);
                  const __m256d xib_7_collide = _mm256_loadu_pd(& _data_pdfs_b[_stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 9*_stride_pdfs_b_3 + ctr_0]);
                  const __m256d xi_370 = _mm256_add_pd(xi_369,xib_7_collide);
                  const __m256d xib_8_collide = _mm256_loadu_pd(& _data_pdfs_b[_stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 13*_stride_pdfs_b_3 + ctr_0]);
                  const __m256d xi_356 = _mm256_add_pd(xib_5_collide,xib_8_collide);
                  ...
                  const __m256d xi_382 = _mm256_mul_pd(xib_9_collide,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0));
                  const __m256d xib_10_collide = _mm256_loadu_pd(& _data_pdfs_b[_stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 11*_stride_pdfs_b_3 + ctr_0]);
                  const __m256d xi_374 = _mm256_mul_pd(xib_10_collide,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0));
                  const __m256d xib_11_collide = _mm256_loadu_pd(& _data_pdfs_b[_stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 10*_stride_pdfs_b_3 + ctr_0]);
                  const __m256d xib_12_collide = _mm256_load_pd(& _data_pdfs_b[_stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + ctr_0]);
                  const __m256d xib_13_collide = _mm256_load_pd(& _data_rho_b[_stride_rho_b_1*ctr_1 + _stride_rho_b_2*ctr_2 + ctr_0]);
                  const __m256d xib_14_collide = _mm256_load_pd(& _data_force_b[_stride_force_b_1*ctr_1 + _stride_force_b_2*ctr_2 + ctr_0]);
                  const __m256d xi_99 = _mm256_mul_pd(xib_14_collide,_mm256_set_pd(0.16666666666666666,0.16666666666666666,0.16666666666666666,0.16666666666666666));
                  const __m256d xi_100 = _mm256_mul_pd(xi_99,_mm256_set_pd(omega_odd_b,omega_odd_b,omega_odd_b,omega_odd_b));
                  const __m256d xi_114 = _mm256_mul_pd(xib_14_collide,_mm256_set_pd(0.083333333333333329,0.083333333333333329,0.083333333333333329,0.083333333333333329));
                  const __m256d xi_116 = _mm256_mul_pd(xib_14_collide,_mm256_set_pd(xi_115,xi_115,xi_115,xi_115));
                  ...
                  const __m256d xib_15_collide = _mm256_loadu_pd(& _data_force_b[_stride_force_b_1*ctr_1 + _stride_force_b_2*ctr_2 + 2*_stride_force_b_3 + ctr_0]);
                  const __m256d xi_108 = _mm256_mul_pd(xib_15_collide,_mm256_set_pd(0.16666666666666666,0.16666666666666666,0.16666666666666666,0.16666666666666666));
                  const __m256d xi_110 = _mm256_mul_pd(xi_108,_mm256_set_pd(omega_odd_b,omega_odd_b,omega_odd_b,omega_odd_b));
                  const __m256d xi_137 = _mm256_mul_pd(xib_15_collide,_mm256_set_pd(0.083333333333333329,0.083333333333333329,0.083333333333333329,0.083333333333333329));
                  const __m256d xi_138 = _mm256_mul_pd(xib_15_collide,_mm256_set_pd(xi_115,xi_115,xi_115,xi_115));
                  ...
                  const __m256d xib_16_collide = _mm256_loadu_pd(& _data_pdfs_b[_stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 6*_stride_pdfs_b_3 + ctr_0]);
                  const __m256d xib_17_collide = _mm256_load_pd(& _data_pdfs_b[_stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 16*_stride_pdfs_b_3 + ctr_0]);
                  const __m256d xi_375 = _mm256_add_pd(xi_374,xib_17_collide);
                  const __m256d xib_18_collide = _mm256_loadu_pd(& _data_pdfs_b[_stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 17*_stride_pdfs_b_3 + ctr_0]);
                  const __m256d xi_357 = _mm256_add_pd(_mm256_add_pd(xi_356,xib_18_collide),xib_9_collide);
                  const __m256d xi_383 = _mm256_add_pd(xi_382,xib_18_collide);
                  ...
                  const __m256d xib_20_collide = _mm256_load_pd(& _data_pdfs_b[_stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 4*_stride_pdfs_b_3 + ctr_0]);
                  const __m256d xib_21_collide = _mm256_loadu_pd(& _data_pdfs_b[_stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 15*_stride_pdfs_b_3 + ctr_0]);
                  const __m256d xib_22_collide = _mm256_loadu_pd(& _data_force_b[_stride_force_b_1*ctr_1 + _stride_force_b_2*ctr_2 + _stride_force_b_3 + ctr_0]);
                  const __m256d xi_86 = _mm256_mul_pd(xib_22_collide,_mm256_set_pd(0.16666666666666666,0.16666666666666666,0.16666666666666666,0.16666666666666666));
                  const __m256d xi_89 = _mm256_mul_pd(xi_86,_mm256_set_pd(omega_odd_b,omega_odd_b,omega_odd_b,omega_odd_b));
                  const __m256d xi_119 = _mm256_mul_pd(xib_22_collide,_mm256_set_pd(0.083333333333333329,0.083333333333333329,0.083333333333333329,0.083333333333333329));
                  const __m256d xi_120 = _mm256_mul_pd(xib_22_collide,_mm256_set_pd(xi_115,xi_115,xi_115,xi_115));
                  const __m256d xi_121 = _mm256_add_pd(_mm256_mul_pd(xi_119,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0)),xi_120);
                  const __m256d xi_123 = _mm256_mul_pd(xib_22_collide,_mm256_set_pd(0.25,0.25,0.25,0.25));
                  const __m256d xi_128 = _mm256_mul_pd(xib_22_collide,_mm256_set_pd(xi_127,xi_127,xi_127,xi_127));
                  const __m256d xi_135 = _mm256_add_pd(_mm256_mul_pd(xi_120,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0)),xi_119);
                  const __m256d xib_23_collide = _mm256_load_pd(& _data_pdfs_b[_stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 12*_stride_pdfs_b_3 + ctr_0]);
                  const __m256d xi_352 = _mm256_add_pd(xib_21_collide,xib_23_collide);
                  const __m256d xi_353 = _mm256_add_pd(_mm256_add_pd(xi_352,xib_10_collide),xib_17_collide);
                  ...
                  const __m256d xib_25_collide = _mm256_loadu_pd(& _data_pdfs_b[_stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 7*_stride_pdfs_b_3 + ctr_0]);
                  const __m256d xi_359 = _mm256_add_pd(xib_11_collide,xib_25_collide);
                  const __m256d xi_360 = _mm256_add_pd(_mm256_add_pd(xi_359,xib_1_collide),xib_7_collide);
                  const __m256d xib_26_collide = _mm256_loadu_pd(& _data_pdfs_b[_stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + _stride_pdfs_b_3 + ctr_0]);
                  const __m256d xi_88 = _mm256_mul_pd(xib_22_collide,_mm256_set_pd(xi_87,xi_87,xi_87,xi_87));
                  const __m256d xi_101 = _mm256_mul_pd(xib_14_collide,_mm256_set_pd(xi_87,xi_87,xi_87,xi_87));
                  const __m256d xi_109 = _mm256_mul_pd(xib_15_collide,_mm256_set_pd(xi_87,xi_87,xi_87,xi_87));
                  const __m256d rho_b_collide = xib_13_collide;
                  ...
                  const __m256d xi_364 = _mm256_add_pd(xi_353,xi_362);
                  ...
                  const __m256d u_0_b_collide = xib_3_collide;
                  const __m256d xi_82 = _mm256_mul_pd(u_0_b_collide,xib_14_collide);
                  ...
                  const __m256d xi_155 = _mm256_mul_pd(u_0_b_collide,xib_15_collide);
                  ...
                  const __m256d u_1_b_collide = xib_4_collide;
                  const __m256d xi_83 = _mm256_mul_pd(u_1_b_collide,xib_22_collide);
                  ...
                  const __m256d xi_126 = _mm256_mul_pd(xi_125,xib_14_collide);
                  const __m256d xi_130 = _mm256_mul_pd(u_1_b_collide,_mm256_set_pd(xi_127,xi_127,xi_127,xi_127));
                  const __m256d xi_131 = _mm256_mul_pd(xi_130,xib_14_collide);
                  ...
                  const __m256d xi_145 = _mm256_mul_pd(xi_125,xib_15_collide);
                  const __m256d xi_147 = _mm256_mul_pd(xi_130,xib_15_collide);
                  const __m256d xi_153 = _mm256_mul_pd(_mm256_mul_pd(_mm256_mul_pd(u_1_b_collide,xib_22_collide),_mm256_set_pd(-0.041666666666666664,-0.041666666666666664,-0.041666666666666664,-0.041666666666666664)),_mm256_set_pd(omega_even_b,omega_even_b,omega_even_b,omega_even_b));
                  const __m256d xi_350 = _mm256_mul_pd(u_1_b_collide,u_1_b_collide);
                  ...
                  const __m256d xi_401 = _mm256_mul_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(xib_7_collide,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0)),_mm256_mul_pd(u_0_b_collide,xi_399)),xi_359),xi_369),_mm256_set_pd(xi_400,xi_400,xi_400,xi_400));
                  const __m256d xi_402 = _mm256_mul_pd(xi_401,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0));
                  const __m256d xi_404 = _mm256_mul_pd(xi_371,_mm256_set_pd(xi_396,xi_396,xi_396,xi_396));
                  const __m256d xi_407 = _mm256_mul_pd(xi_376,_mm256_set_pd(xi_396,xi_396,xi_396,xi_396));
                  const __m256d xi_412 = _mm256_mul_pd(xi_407,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0));
                  const __m256d u_2_b_collide = xib_24_collide;
                  const __m256d xi_84 = _mm256_mul_pd(u_2_b_collide,xib_15_collide);
                  ...
                  const __m256d xi_118 = _mm256_mul_pd(_mm256_mul_pd(_mm256_mul_pd(u_2_b_collide,xib_15_collide),_mm256_set_pd(-0.041666666666666664,-0.041666666666666664,-0.041666666666666664,-0.041666666666666664)),_mm256_set_pd(omega_even_b,omega_even_b,omega_even_b,omega_even_b));
                  ...
                  const __m256d xi_157 = _mm256_mul_pd(u_2_b_collide,xib_14_collide);
                  ...
                  const __m256d xi_346 = _mm256_mul_pd(u_2_b_collide,u_2_b_collide);
                  ...
                  const __m256d xi_389 = _mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(xi_363,_mm256_set_pd(0.5,0.5,0.5,0.5)),xi_379),xi_388);
                  const __m256d xi_390 = _mm256_mul_pd(u_2_b_collide,xi_367);
                  const __m256d xi_391 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(xib_23_collide,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0)),xi_375),xi_390),xib_21_collide);
                  const __m256d xi_392 = _mm256_mul_pd(xi_391,_mm256_set_pd(xi_372,xi_372,xi_372,xi_372));
                  const __m256d xi_393 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(xib_8_collide,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0)),xi_383),xi_390),xib_5_collide);
                  ...
                  const __m256d xi_408 = _mm256_mul_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(xib_17_collide,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0)),_mm256_mul_pd(u_2_b_collide,xi_399)),xi_352),xi_374),_mm256_set_pd(xi_400,xi_400,xi_400,xi_400));
                  const __m256d xi_409 = _mm256_mul_pd(xi_354,_mm256_set_pd(0.25,0.25,0.25,0.25));
                  const __m256d xi_410 = _mm256_mul_pd(xi_391,_mm256_set_pd(xi_396,xi_396,xi_396,xi_396));
                  const __m256d xi_411 = _mm256_add_pd(xi_409,xi_410);
                  const __m256d xi_413 = _mm256_mul_pd(xi_408,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0));
                  const __m256d xi_416 = _mm256_mul_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(xib_18_collide,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0)),_mm256_mul_pd(_mm256_mul_pd(rho_b_collide,u_0_b_collide),u_2_b_collide)),xi_356),xi_382),_mm256_set_pd(xi_400,xi_400,xi_400,xi_400));
                  ...
                  const __m256d xi_419 = _mm256_mul_pd(xi_393,_mm256_set_pd(xi_396,xi_396,xi_396,xi_396));
                  ...
                  const __m256d tmp_a1 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(xi_252,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0)),_mm256_mul_pd(xi_256,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),forceTerm_1_a_collide),xi_259),xi_262),xia_26_collide);
                  const __m256d tmp_a2 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(forceTerm_2_a_collide,xi_252),xi_256),xi_262),xi_263),xia_17_collide);
                  const __m256d tmp_a3 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(forceTerm_3_a_collide,xi_268),xi_270),xi_271),xi_273),xia_22_collide);
                  const __m256d tmp_a4 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(xi_268,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0)),_mm256_mul_pd(xi_270,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),forceTerm_4_a_collide),xi_273),xi_274),xia_3_collide);
                  const __m256d tmp_a5 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(xi_277,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0)),_mm256_mul_pd(xi_279,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),forceTerm_5_a_collide),xi_280),xi_281),xia_21_collide);
                  const __m256d tmp_a6 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(forceTerm_6_a_collide,xi_277),xi_279),xi_281),xi_282),xia_5_collide);
                  const __m256d tmp_a7 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(forceTerm_7_a_collide,xi_285),xi_289),xi_298),xi_301),xia_25_collide);
                  const __m256d tmp_a8 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(forceTerm_8_a_collide,xi_284),xi_288),xi_301),xi_307),xia_19_collide);
                  const __m256d tmp_a9 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(forceTerm_9_a_collide,xi_285),xi_288),xi_308),xi_309),xia_14_collide);
                  const __m256d tmp_a10 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(forceTerm_10_a_collide,xi_284),xi_289),xi_309),xi_310),xia_20_collide);
                  ...
                  const __m256d tmp_a12 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(forceTerm_12_a_collide,xi_320),xi_321),xi_322),xi_326),xia_15_collide);
                  const __m256d tmp_a13 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(forceTerm_13_a_collide,xi_328),xi_330),xi_333),xi_336),xia_23_collide);
                  const __m256d tmp_a14 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(forceTerm_14_a_collide,xi_327),xi_329),xi_336),xi_339),xia_9_collide);
                  const __m256d tmp_a15 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(forceTerm_15_a_collide,xi_311),xi_322),xi_340),xi_341),xia_13_collide);
                  const __m256d tmp_a16 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(forceTerm_16_a_collide,xi_312),xi_321),xi_341),xi_342),xia_7_collide);
                  const __m256d tmp_a17 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(forceTerm_17_a_collide,xi_328),xi_329),xi_343),xi_344),xia_10_collide);
                  const __m256d tmp_a18 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(forceTerm_18_a_collide,xi_327),xi_330),xi_344),xi_345),xia_16_collide);
                  const __m256d tmp_b0 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(xi_363,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0)),_mm256_mul_pd(xi_365,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),_mm256_mul_pd(xi_366,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),forceTerm_0_b_collide),xi_245),xi_354),xi_358),xi_361),xib_12_collide);
                  const __m256d tmp_b1 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(xi_373,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0)),_mm256_mul_pd(xi_377,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),forceTerm_1_b_collide),xi_259),xi_380),xib_26_collide);
                  const __m256d tmp_b2 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(forceTerm_2_b_collide,xi_263),xi_373),xi_377),xi_380),xib_19_collide);
                  const __m256d tmp_b3 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(forceTerm_3_b_collide,xi_271),xi_385),xi_387),xi_389),xib_6_collide);
                  const __m256d tmp_b4 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(xi_385,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0)),_mm256_mul_pd(xi_387,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),forceTerm_4_b_collide),xi_274),xi_389),xib_20_collide);
                  const __m256d tmp_b5 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(xi_392,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0)),_mm256_mul_pd(xi_394,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),forceTerm_5_b_collide),xi_280),xi_395),xib_2_collide);
                  const __m256d tmp_b6 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(forceTerm_6_b_collide,xi_282),xi_392),xi_394),xi_395),xib_16_collide);
                  const __m256d tmp_b7 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(forceTerm_7_b_collide,xi_298),xi_398),xi_402),xi_405),xib_25_collide);
                  const __m256d tmp_b8 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(forceTerm_8_b_collide,xi_307),xi_397),xi_401),xi_405),xib_1_collide);
                  const __m256d tmp_b9 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(forceTerm_9_b_collide,xi_308),xi_398),xi_401),xi_406),xib_7_collide);
                  const __m256d tmp_b10 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(forceTerm_10_b_collide,xi_310),xi_397),xi_402),xi_406),xib_11_collide);
                  const __m256d tmp_b11 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(forceTerm_11_b_collide,xi_317),xi_407),xi_408),xi_411),xib_10_collide);
                  const __m256d tmp_b12 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(forceTerm_12_b_collide,xi_326),xi_411),xi_412),xi_413),xib_23_collide);
                  const __m256d tmp_b13 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(forceTerm_13_b_collide,xi_333),xi_415),xi_417),xi_420),xib_8_collide);
                  const __m256d tmp_b14 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(forceTerm_14_b_collide,xi_339),xi_414),xi_416),xi_420),xib_9_collide);
                  const __m256d tmp_b15 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(forceTerm_15_b_collide,xi_340),xi_407),xi_413),xi_421),xib_21_collide);
                  const __m256d tmp_b16 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(forceTerm_16_b_collide,xi_342),xi_408),xi_412),xi_421),xib_17_collide);
                  const __m256d tmp_b17 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(forceTerm_17_b_collide,xi_343),xi_415),xi_416),xi_422),xib_18_collide);
                  const __m256d tmp_b18 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(forceTerm_18_b_collide,xi_345),xi_414),xi_417),xi_422),xib_5_collide);
               ...
               for (int64_t ctr_0 = (int64_t)((_size_force_a_0 - 2) / (4)) * (4) + 1; ctr_0 < _size_force_a_0 - 1; ctr_0 += 1)
               {
                  ...
                  const double xia_2_collide = _data_force_a[_stride_force_a_1*ctr_1 + _stride_force_a_2*ctr_2 + 2*_stride_force_a_3 + ctr_0];
                  const double xi_26 = xia_2_collide*0.16666666666666666;
                  const double xi_28 = omega_odd_a*xi_26;
                  const double xi_55 = xia_2_collide*0.083333333333333329;
                  const double xi_56 = xi_33*xia_2_collide;
                  const double xi_57 = xi_55 - xi_56;
                  const double xi_70 = -xi_55 + xi_56;
                  const double xia_3_collide = _data_pdfs_a[_stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 4*_stride_pdfs_a_3 + ctr_0];
                  const double xia_4_collide = _data_force_a[_stride_force_a_1*ctr_1 + _stride_force_a_2*ctr_2 + _stride_force_a_3 + ctr_0];
                  const double xi_4 = xia_4_collide*0.16666666666666666;
                  const double xi_7 = omega_odd_a*xi_4;
                  const double xi_37 = xia_4_collide*0.083333333333333329;
                  const double xi_38 = xi_33*xia_4_collide;
                  const double xi_39 = -xi_37 + xi_38;
                  const double xi_41 = xia_4_collide*0.25;
                  const double xi_46 = xi_45*xia_4_collide;
                  const double xi_53 = xi_37 - xi_38;
                  const double xia_5_collide = _data_pdfs_a[_stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 6*_stride_pdfs_a_3 + ctr_0];
                  const double xia_6_collide = _data_velocity[_stride_velocity_1*ctr_1 + _stride_velocity_2*ctr_2 + ctr_0];
                  const double xia_7_collide = _data_pdfs_a[_stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 16*_stride_pdfs_a_3 + ctr_0];
                  const double xi_254 = xi_253 + xia_7_collide;
                  const double xia_8_collide = _data_velocity[_stride_velocity_1*ctr_1 + _stride_velocity_2*ctr_2 + _stride_velocity_3 + ctr_0];
                  const double xia_9_collide = _data_pdfs_a[_stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 14*_stride_pdfs_a_3 + ctr_0];
                  const double xi_265 = -xia_9_collide;
                  const double xia_10_collide = _data_pdfs_a[_stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 17*_stride_pdfs_a_3 + ctr_0];
                  const double xi_266 = xi_265 + xia_10_collide;
                  const double xia_11_collide = _data_force_a[_stride_force_a_1*ctr_1 + _stride_force_a_2*ctr_2 + ctr_0];
                  const double xi_17 = xia_11_collide*0.16666666666666666;
                  const double xi_18 = omega_odd_a*xi_17;
                  const double xi_32 = xia_11_collide*0.083333333333333329;
                  const double xi_34 = xi_33*xia_11_collide;
                  const double xi_35 = xi_32 - xi_34;
                  const double xi_51 = -xi_32 + xi_34;
                  const double xia_12_collide = _data_rho_a[_stride_rho_a_1*ctr_1 + _stride_rho_a_2*ctr_2 + ctr_0];
                  const double xia_13_collide = _data_pdfs_a[_stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 15*_stride_pdfs_a_3 + ctr_0];
                  const double xia_14_collide = _data_pdfs_a[_stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 9*_stride_pdfs_a_3 + ctr_0];
                  const double xia_15_collide = _data_pdfs_a[_stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 12*_stride_pdfs_a_3 + ctr_0];
                  const double xi_170 = xia_13_collide + xia_15_collide;
                  const double xi_171 = xi_170 + xia_1_collide + xia_7_collide;
                  const double xia_16_collide = _data_pdfs_a[_stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 18*_stride_pdfs_a_3 + ctr_0];
                  const double xia_17_collide = _data_pdfs_a[_stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 2*_stride_pdfs_a_3 + ctr_0];
                  const double xia_18_collide = _data_velocity[_stride_velocity_1*ctr_1 + _stride_velocity_2*ctr_2 + 2*_stride_velocity_3 + ctr_0];
                  const double xia_19_collide = _data_pdfs_a[_stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 8*_stride_pdfs_a_3 + ctr_0];
                  const double xi_248 = -xia_19_collide;
                  const double xi_249 = xi_248 + xia_14_collide;
                  const double xia_20_collide = _data_pdfs_a[_stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 10*_stride_pdfs_a_3 + ctr_0];
                  const double xia_21_collide = _data_pdfs_a[_stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 5*_stride_pdfs_a_3 + ctr_0];
                  ...
                  const double xi_174 = xia_16_collide + xia_23_collide;
                  const double xi_175 = xi_174 + xia_10_collide + xia_9_collide;
                  const double xia_24_collide = _data_pdfs_a[_stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + ctr_0];
                  const double xia_25_collide = _data_pdfs_a[_stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 7*_stride_pdfs_a_3 + ctr_0];
                  const double xi_177 = xia_20_collide + xia_25_collide;
                  const double xi_178 = xi_177 + xia_14_collide + xia_19_collide;
                  const double xia_26_collide = _data_pdfs_a[_stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + _stride_pdfs_a_3 + ctr_0];
                  const double xi_6 = xi_5*xia_4_collide;
                  const double xi_19 = xi_5*xia_11_collide;
                  const double xi_27 = xi_5*xia_2_collide;
                  const double rho_a_collide = xia_12_collide;
                  ...
                  const double xi_0 = u_0_a_collide*xia_11_collide;
                  ...
                  const double xi_73 = u_0_a_collide*xia_2_collide;
                  ...
                  const double xi_182 = omega_shear_a*(rho_a_collide*xi_166 - xi_178 - xi_181 - xia_22_collide - xia_3_collide);
                  const double xi_264 = u_0_a_collide*xi_246;
                  const double xi_267 = xi_264 + xi_266 - xia_16_collide + xia_23_collide;
                  const double xi_268 = xi_251*xi_267;
                  const double xi_269 = xi_249 + xi_264 - xia_20_collide + xia_25_collide;
                  ...
                  const double u_1_a_collide = xia_8_collide;
                  const double xi_1 = u_1_a_collide*xia_4_collide;
                  ...
                  const double xi_44 = xi_43*xia_11_collide;
                  const double xi_48 = u_1_a_collide*xi_45;
                  const double xi_49 = xi_48*xia_11_collide;
                  const double xi_50 = xi_42 + xi_44 - xi_47 - xi_49;
                  const double xi_52 = -xi_42 - xi_44 + xi_47 + xi_49;
                  const double xi_59 = -xi_23;
                  const double xi_63 = xi_43*xia_2_collide;
                  const double xi_65 = xi_48*xia_2_collide;
                  const double xi_71 = omega_even_a*u_1_a_collide*xia_4_collide*-0.041666666666666664;
                  const double xi_164 = (u_1_a_collide*u_1_a_collide);
                  const double xi_165 = rho_a_collide*xi_164*-0.33333333333333331;
                  const double xi_183 = omega_shear_a*(rho_a_collide*xi_164 - xi_171 - xi_178 - xi_180 - xia_17_collide - xia_26_collide);
                  const double xi_247 = u_1_a_collide*xi_246;
                  const double xi_250 = xi_247 + xi_249 + xia_20_collide - xia_25_collide;
                  const double xi_252 = xi_250*xi_251;
                  const double xi_255 = xi_247 + xi_254 - xia_13_collide + xia_15_collide;
                  const double xi_256 = xi_251*xi_255;
                  const double xi_286 = rho_a_collide*u_1_a_collide;
                  const double xi_288 = xi_287*(u_0_a_collide*xi_286 + xi_177 + xi_248 - xia_14_collide);
                  const double xi_289 = -xi_288;
                  const double xi_300 = xi_250*xi_283;
                  const double xi_311 = xi_255*xi_283;
                  const double xi_321 = -xi_311;
                  const double u_2_a_collide = xia_18_collide;
                  const double xi_2 = u_2_a_collide*xia_2_collide;
                  ...
                  const double xi_36 = omega_even_a*u_2_a_collide*xia_2_collide*-0.041666666666666664;
                  ...
                  const double xi_75 = u_2_a_collide*xia_11_collide;
                  ...
                  const double xi_184 = omega_shear_a*(rho_a_collide*xi_168 - xi_171 - xi_181 - xia_21_collide - xia_5_collide);
                  ...
                  const double xi_276 = xi_266 + xi_275 + xia_16_collide - xia_23_collide;
                  const double xi_277 = xi_251*xi_276;
                  const double xi_278 = xi_254 + xi_275 + xia_13_collide - xia_15_collide;
                  ...
                  const double xi_312 = xi_287*(u_2_a_collide*xi_286 + xi_170 + xi_253 - xia_7_collide);
                  ...
                  const double xi_329 = xi_287*(rho_a_collide*u_0_a_collide*u_2_a_collide + xi_174 + xi_265 - xia_10_collide);
                  ...
                  const double forceTerm_0_a_collide = omega_shear_a*u_0_a_collide*xia_11_collide + omega_shear_a*u_1_a_collide*xia_4_collide + omega_shear_a*u_2_a_collide*xia_2_collide - xi_0*xi_3 - xi_0 - xi_1*xi_3 - xi_1 - xi_2*xi_3 - xi_2;
                  ...
                  const double xib_1_collide = _data_pdfs_b[_stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 8*_stride_pdfs_b_3 + ctr_0];
                  const double xi_369 = -xib_1_collide;
                  const double xib_2_collide = _data_pdfs_b[_stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 5*_stride_pdfs_b_3 + ctr_0];
                  const double xib_3_collide = _data_velocity[_stride_velocity_1*ctr_1 + _stride_velocity_2*ctr_2 + ctr_0];
                  const double xib_4_collide = _data_velocity[_stride_velocity_1*ctr_1 + _stride_velocity_2*ctr_2 + _stride_velocity_3 + ctr_0];
                  const double xib_5_collide = _data_pdfs_b[_stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 18*_stride_pdfs_b_3 + ctr_0];
                  const double xib_6_collide = _data_pdfs_b[_stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 3*_stride_pdfs_b_3 + ctr_0];
                  const double xib_7_collide = _data_pdfs_b[_stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 9*_stride_pdfs_b_3 + ctr_0];
                  const double xi_370 = xi_369 + xib_7_collide;
                  const double xib_8_collide = _data_pdfs_b[_stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 13*_stride_pdfs_b_3 + ctr_0];
                  const double xi_356 = xib_5_collide + xib_8_collide;
                  const double xib_9_collide = _data_pdfs_b[_stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 14*_stride_pdfs_b_3 + ctr_0];
                  const double xi_382 = -xib_9_collide;
                  const double xib_10_collide = _data_pdfs_b[_stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 11*_stride_pdfs_b_3 + ctr_0];
                  const double xi_374 = -xib_10_collide;
                  const double xib_11_collide = _data_pdfs_b[_stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 10*_stride_pdfs_b_3 + ctr_0];
                  const double xib_12_collide = _data_pdfs_b[_stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + ctr_0];
                  const double xib_13_collide = _data_rho_b[_stride_rho_b_1*ctr_1 + _stride_rho_b_2*ctr_2 + ctr_0];
                  const double xib_14_collide = _data_force_b[_stride_force_b_1*ctr_1 + _stride_force_b_2*ctr_2 + ctr_0];
                  const double xi_99 = xib_14_collide*0.16666666666666666;
                  const double xi_100 = omega_odd_b*xi_99;
                  const double xi_114 = xib_14_collide*0.083333333333333329;
                  const double xi_116 = xi_115*xib_14_collide;
                  const double xi_117 = xi_114 - xi_116;
                  const double xi_133 = -xi_114 + xi_116;
                  const double xib_15_collide = _data_force_b[_stride_force_b_1*ctr_1 + _stride_force_b_2*ctr_2 + 2*_stride_force_b_3 + ctr_0];
                  const double xi_108 = xib_15_collide*0.16666666666666666;
                  const double xi_110 = omega_odd_b*xi_108;
                  const double xi_137 = xib_15_collide*0.083333333333333329;
                  const double xi_138 = xi_115*xib_15_collide;
                  const double xi_139 = xi_137 - xi_138;
                  const double xi_152 = -xi_137 + xi_138;
                  const double xib_16_collide = _data_pdfs_b[_stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 6*_stride_pdfs_b_3 + ctr_0];
                  const double xib_17_collide = _data_pdfs_b[_stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 16*_stride_pdfs_b_3 + ctr_0];
                  const double xi_375 = xi_374 + xib_17_collide;
                  const double xib_18_collide = _data_pdfs_b[_stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 17*_stride_pdfs_b_3 + ctr_0];
                  const double xi_357 = xi_356 + xib_18_collide + xib_9_collide;
                  const double xi_383 = xi_382 + xib_18_collide;
                  const double xib_19_collide = _data_pdfs_b[_stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 2*_stride_pdfs_b_3 + ctr_0];
                  const double xib_20_collide = _data_pdfs_b[_stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 4*_stride_pdfs_b_3 + ctr_0];
                  const double xib_21_collide = _data_pdfs_b[_stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 15*_stride_pdfs_b_3 + ctr_0];
                  const double xib_22_collide = _data_force_b[_stride_force_b_1*ctr_1 + _stride_force_b_2*ctr_2 + _stride_force_b_3 + ctr_0];
                  const double xi_86 = xib_22_collide*0.16666666666666666;
                  const double xi_89 = omega_odd_b*xi_86;
                  const double xi_119 = xib_22_collide*0.083333333333333329;
                  const double xi_120 = xi_115*xib_22_collide;
                  const double xi_121 = -xi_119 + xi_120;
                  const double xi_123 = xib_22_collide*0.25;
                  const double xi_128 = xi_127*xib_22_collide;
                  const double xi_135 = xi_119 - xi_120;
                  const double xib_23_collide = _data_pdfs_b[_stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 12*_stride_pdfs_b_3 + ctr_0];
                  const double xi_352 = xib_21_collide + xib_23_collide;
                  const double xi_353 = xi_352 + xib_10_collide + xib_17_collide;
                  const double xib_24_collide = _data_velocity[_stride_velocity_1*ctr_1 + _stride_velocity_2*ctr_2 + 2*_stride_velocity_3 + ctr_0];
                  const double xib_25_collide = _data_pdfs_b[_stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 7*_stride_pdfs_b_3 + ctr_0];
                  const double xi_359 = xib_11_collide + xib_25_collide;
                  const double xi_360 = xi_359 + xib_1_collide + xib_7_collide;
                  const double xib_26_collide = _data_pdfs_b[_stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + _stride_pdfs_b_3 + ctr_0];
                  const double xi_88 = xi_87*xib_22_collide;
                  const double xi_101 = xi_87*xib_14_collide;
                  const double xi_109 = xi_87*xib_15_collide;
                  const double rho_b_collide = xib_13_collide;
                  ...
                  const double u_0_b_collide = xib_3_collide;
                  const double xi_82 = u_0_b_collide*xib_14_collide;
                  ...
                  const double xi_155 = u_0_b_collide*xib_15_collide;
                  ...
                  const double xi_363 = omega_shear_b*(rho_b_collide*xi_348 - xi_357 - xi_360 - xi_362 - xib_20_collide - xib_6_collide);
                  const double xi_381 = u_0_b_collide*xi_367;
                  const double xi_384 = xi_381 + xi_383 - xib_5_collide + xib_8_collide;
                  const double xi_385 = xi_372*xi_384;
                  const double xi_386 = xi_370 + xi_381 - xib_11_collide + xib_25_collide;
                  ...
                  const double xi_83 = u_1_b_collide*xib_22_collide;
                  ...
                  const double xi_126 = xi_125*xib_14_collide;
                  const double xi_130 = u_1_b_collide*xi_127;
                  const double xi_131 = xi_130*xib_14_collide;
                  const double xi_132 = xi_124 + xi_126 - xi_129 - xi_131;
                  const double xi_134 = -xi_124 - xi_126 + xi_129 + xi_131;
                  const double xi_141 = -xi_105;
                  const double xi_145 = xi_125*xib_15_collide;
                  const double xi_147 = xi_130*xib_15_collide;
                  const double xi_153 = omega_even_b*u_1_b_collide*xib_22_collide*-0.041666666666666664;
                  const double xi_350 = (u_1_b_collide*u_1_b_collide);
                  const double xi_351 = rho_b_collide*xi_350*-0.33333333333333331 + xi_349;
                  const double xi_365 = omega_shear_b*(rho_b_collide*xi_350 - xi_360 - xi_364 - xib_19_collide - xib_26_collide);
                  const double xi_368 = u_1_b_collide*xi_367;
                  const double xi_371 = xi_368 + xi_370 + xib_11_collide - xib_25_collide;
                  const double xi_373 = xi_371*xi_372;
                  const double xi_376 = xi_368 + xi_375 - xib_21_collide + xib_23_collide;
                  const double xi_377 = xi_372*xi_376;
                  const double xi_399 = rho_b_collide*u_1_b_collide;
                  const double xi_401 = xi_400*(u_0_b_collide*xi_399 + xi_359 + xi_369 - xib_7_collide);
                  ...
                  const double xi_84 = u_2_b_collide*xib_15_collide;
                  ...
                  const double xi_118 = omega_even_b*u_2_b_collide*xib_15_collide*-0.041666666666666664;
                  ...
                  const double xi_157 = u_2_b_collide*xib_14_collide;
                  ...
                  const double xi_366 = omega_shear_b*(rho_b_collide*xi_346 - xi_357 - xi_364 - xib_16_collide - xib_2_collide);
                  ...
                  const double xi_391 = xi_375 + xi_390 + xib_21_collide - xib_23_collide;
                  const double xi_392 = xi_372*xi_391;
                  const double xi_393 = xi_383 + xi_390 + xib_5_collide - xib_8_collide;
                  ...
                  const double xi_408 = xi_400*(u_2_b_collide*xi_399 + xi_352 + xi_374 - xib_17_collide);
                  const double xi_409 = xi_354*0.25;
                  const double xi_410 = xi_391*xi_396;
                  const double xi_411 = xi_409 + xi_410;
                  const double xi_413 = -xi_408;
                  const double xi_416 = xi_400*(rho_b_collide*u_0_b_collide*u_2_b_collide + xi_356 + xi_382 - xib_18_collide);
                  const double xi_417 = -xi_416;
                  const double xi_418 = xi_358*0.25;
                  const double xi_419 = xi_393*xi_396;
                  const double xi_420 = xi_418 + xi_419;
                  const double xi_421 = xi_409 - xi_410;
                  const double xi_422 = xi_418 - xi_419;
                  const double forceTerm_0_b_collide = omega_shear_b*u_0_b_collide*xib_14_collide + omega_shear_b*u_1_b_collide*xib_22_collide + omega_shear_b*u_2_b_collide*xib_15_collide - xi_82*xi_85 - xi_82 - xi_83*xi_85 - xi_83 - xi_84*xi_85 - xi_84;
                  ...
                  const double tmp_a0 = forceTerm_0_a_collide + xi_172 + xi_176 + xi_179 - xi_182 - xi_183 - xi_184 + xi_245 + xia_24_collide;
                  const double tmp_a1 = forceTerm_1_a_collide - xi_252 - xi_256 + xi_259 + xi_262 + xia_26_collide;
                  const double tmp_a2 = forceTerm_2_a_collide + xi_252 + xi_256 + xi_262 + xi_263 + xia_17_collide;
                  const double tmp_a3 = forceTerm_3_a_collide + xi_268 + xi_270 + xi_271 + xi_273 + xia_22_collide;
                  const double tmp_a4 = forceTerm_4_a_collide - xi_268 - xi_270 + xi_273 + xi_274 + xia_3_collide;
                  const double tmp_a5 = forceTerm_5_a_collide - xi_277 - xi_279 + xi_280 + xi_281 + xia_21_collide;
                  const double tmp_a6 = forceTerm_6_a_collide + xi_277 + xi_279 + xi_281 + xi_282 + xia_5_collide;
                  const double tmp_a7 = forceTerm_7_a_collide + xi_285 + xi_289 + xi_298 + xi_301 + xia_25_collide;
                  const double tmp_a8 = forceTerm_8_a_collide + xi_284 + xi_288 + xi_301 + xi_307 + xia_19_collide;
                  const double tmp_a9 = forceTerm_9_a_collide + xi_285 + xi_288 + xi_308 + xi_309 + xia_14_collide;
                  const double tmp_a10 = forceTerm_10_a_collide + xi_284 + xi_289 + xi_309 + xi_310 + xia_20_collide;
                  const double tmp_a11 = forceTerm_11_a_collide + xi_311 + xi_312 + xi_317 + xi_320 + xia_1_collide;
                  const double tmp_a12 = forceTerm_12_a_collide + xi_320 + xi_321 + xi_322 + xi_326 + xia_15_collide;
                  const double tmp_a13 = forceTerm_13_a_collide + xi_328 + xi_330 + xi_333 + xi_336 + xia_23_collide;
                  const double tmp_a14 = forceTerm_14_a_collide + xi_327 + xi_329 + xi_336 + xi_339 + xia_9_collide;
                  const double tmp_a15 = forceTerm_15_a_collide + xi_311 + xi_322 + xi_340 + xi_341 + xia_13_collide;
                  const double tmp_a16 = forceTerm_16_a_collide + xi_312 + xi_321 + xi_341 + xi_342 + xia_7_collide;
                  const double tmp_a17 = forceTerm_17_a_collide + xi_328 + xi_329 + xi_343 + xi_344 + xia_10_collide;
                  const double tmp_a18 = forceTerm_18_a_collide + xi_327 + xi_330 + xi_344 + xi_345 + xia_16_collide;
                  const double tmp_b0 = forceTerm_0_b_collide + xi_245 + xi_354 + xi_358 + xi_361 - xi_363 - xi_365 - xi_366 + xib_12_collide;
                  const double tmp_b1 = forceTerm_1_b_collide + xi_259 - xi_373 - xi_377 + xi_380 + xib_26_collide;
                  const double tmp_b2 = forceTerm_2_b_collide + xi_263 + xi_373 + xi_377 + xi_380 + xib_19_collide;
                  const double tmp_b3 = forceTerm_3_b_collide + xi_271 + xi_385 + xi_387 + xi_389 + xib_6_collide;
                  const double tmp_b4 = forceTerm_4_b_collide + xi_274 - xi_385 - xi_387 + xi_389 + xib_20_collide;
                  const double tmp_b5 = forceTerm_5_b_collide + xi_280 - xi_392 - xi_394 + xi_395 + xib_2_collide;
                  const double tmp_b6 = forceTerm_6_b_collide + xi_282 + xi_392 + xi_394 + xi_395 + xib_16_collide;
                  const double tmp_b7 = forceTerm_7_b_collide + xi_298 + xi_398 + xi_402 + xi_405 + xib_25_collide;
                  const double tmp_b8 = forceTerm_8_b_collide + xi_307 + xi_397 + xi_401 + xi_405 + xib_1_collide;
                  const double tmp_b9 = forceTerm_9_b_collide + xi_308 + xi_398 + xi_401 + xi_406 + xib_7_collide;
                  const double tmp_b10 = forceTerm_10_b_collide + xi_310 + xi_397 + xi_402 + xi_406 + xib_11_collide;
                  const double tmp_b11 = forceTerm_11_b_collide + xi_317 + xi_407 + xi_408 + xi_411 + xib_10_collide;
                  const double tmp_b12 = forceTerm_12_b_collide + xi_326 + xi_411 + xi_412 + xi_413 + xib_23_collide;
                  const double tmp_b13 = forceTerm_13_b_collide + xi_333 + xi_415 + xi_417 + xi_420 + xib_8_collide;
                  const double tmp_b14 = forceTerm_14_b_collide + xi_339 + xi_414 + xi_416 + xi_420 + xib_9_collide;
                  const double tmp_b15 = forceTerm_15_b_collide + xi_340 + xi_407 + xi_413 + xi_421 + xib_21_collide;
                  const double tmp_b16 = forceTerm_16_b_collide + xi_342 + xi_408 + xi_412 + xi_421 + xib_17_collide;
                  const double tmp_b17 = forceTerm_17_b_collide + xi_343 + xi_415 + xi_416 + xi_422 + xib_18_collide;
                  const double tmp_b18 = forceTerm_18_b_collide + xi_345 + xi_414 + xi_417 + xi_422 + xib_5_collide;
